...
<p>Перейдите в консоль администратора и откройте меню <strong>Администрирование - Роли</strong>. Подробнее читайте в статьях: <a href="../admin/HowToEnterTheAdmin.md">Вход в консоль администратора</a> и <a href="../admin/Roles.md">Настройка ролей</a>.</p>
