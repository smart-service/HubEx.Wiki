...
description: >-
  Общая информация о маркировки Честный зкак - Data Matrix, для чего нужен и как
  использовать
keywords: >-
  Маркировка, Честный знак, Честный, Знак, DataMatrix, Data Matrix, Дата
  Матрикс, материалы, списание, Выполненные работы, Выполнение, hubex, хабекс,
  хубекс, хабикс
category: user
---
...
<p dir="auto">Подробнее читайте в статье <a href="../admin/Roles.html">Настройка ролей</a></p>
<hr class=" border-gray-100 dark:border-gray-850" />
...
<p dir="auto">Подробнее читайте в статье <a href="./Materials.html">Загрузка материалов и создание складов</a></p>
<hr class=" border-gray-100 dark:border-gray-850" />
...
<p dir="auto">Подробнее читайте в статье <a href="../admin/ElementsOfInterface.html">Поля на форме заявки: настройка доступа к полям заявки</a></p>
<hr class=" border-gray-100 dark:border-gray-850" />
...
<hr class=" border-gray-100 dark:border-gray-850" />
<p dir="auto">Если у вас возникли вопросы &mdash; пишите в поддержку Telegram @hubex_bot или на почту <a href="mailto:help@hubex.ru" target="_blank" rel="nofollow">help@hubex.ru</a>.</p>
</body>

___
### Следующие шаги:
- [Настройка ролей](../admin/Roles.html)
- [Загрузка материалов и создание складов](./Materials.html)
- [Поля на форме заявки: настройка доступа к полям заявки](../admin/ElementsOfInterface.html)
- [Прикрепление выполненных работ в web- и мобильном приложении](./AttachingFiles.html)
