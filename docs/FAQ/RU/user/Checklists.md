...
keywords: чек-листы, чек-лист офлайн, оффлайн, без интернета, атрибут чек-листа, атрибут, чеклист, заполнение чек-листа, создать чек-лист, hubex, хабекс, хубекс, хабикс
---
...
<p>При отсутствии подключения к сети в приложении отображается нескрываемое уведомление <strong>Нет подключения к
    интернету</strong>. В
    этом случае вы все равно заполнить <strong>Чек-лист</strong>. Для этого откройте <strong>Заявку</strong> и <a
...
<p>После сохранения у <strong>Чек-листа</strong> вы увидите значок синхронизации. При появлении сети <strong>Чек-лист</strong> будет автоматически
