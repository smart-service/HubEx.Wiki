---
title: >-
  Поддержка дополнительных полей-справочников для чек-листов, Редактирование
  выполненных работ (ВР) в офлайн-режиме
description: >-
  Добавили возможность работы с дополнительными полями-справочникам для
  чек-листов, Добавили возможность созданную в офлайне выполненную работу
keywords: >-
  чек-лист, дополнительное поле, справочник, выполненная работа, офлайн, hubex,
...
<ol start="1">
<li>
<p class="ds-markdown-paragraph">Вы открываете существующую заявку.</p>
</li>
<li>
<p class="ds-markdown-paragraph">Переходите в офлайн-режим (из-за потери сети).</p>
</li>
<li>
<p class="ds-markdown-paragraph">Создаёте новую выполненную работу (ВР) прямо в этой заявке.</p>
</li>
<li>
<p class="ds-markdown-paragraph"><strong>Сразу же открываете созданную ВР</strong>&nbsp;&mdash; она доступна для редактирования.</p>
</li>
<li>
<p class="ds-markdown-paragraph">Вносите изменения, добавляете материалы.</p>
</li>
<li>
