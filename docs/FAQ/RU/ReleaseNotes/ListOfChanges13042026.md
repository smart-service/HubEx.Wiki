---
title: >-
  Предпросмотр PDF-файлов в веб-версии HubEx, Кастомный паспорт объекта для
  QR-кодов
description: >-
  Добавили возможность предпросмотра PDF прямо в браузере, Добавили возможность
  заказа кастомного паспорта объектов
keywords: 'PDF, предпросмотр, паспорт, QR, hubex, хабекс, хубекс, хабикс'
