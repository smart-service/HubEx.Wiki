...
description: 'В HubEx можно прикреплять фото и видео к сообщениям в чате с заказчиком и командой — до 10 файлов за раз.'
keywords: 
...
<p>Подробнее о сообщениях и чатах читайте в статье базы знаний: <a href="../user/Messages.html">Сообщения по заявке</a>.</p>
