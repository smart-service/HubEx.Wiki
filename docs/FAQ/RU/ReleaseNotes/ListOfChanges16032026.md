...
description: Добавили возможность работы с дополнительными полями-справочникам для чек-листов, Добавили возможность созданную в офлайне выполненную работу
keywords: чек-лист, дополнительное поле, справочник, выполненная работа, офлайн, hubex, хабекс, хубекс, хабикс
---
