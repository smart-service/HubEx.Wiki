...
<p class="" data-start="3165" data-end="3344">Инструкции по работе с конструктором печатных форм можно посмотреть <a href="../user/PrintingFormDesigner.md" target="_blank" rel="noopener">здесь</a></p>
