...
<ul>
    ...
    <li><strong>Тип (Тип оборудования)</strong> - это классификатор объектов (оборудования) по признаку наличия адреса.
        <p>В системе HubEx
            ...
            Например, <strong>Объектом</strong> может быть Бизнес-центр с адресом ул. Ермакова 3, а
    ...
    <li>флажок <strong>Разрешить создавать заявки по этому объекту</strong> делает <strong>Объект</strong> доступным для выбора в <strong>Заявке</strong>. Такой <strong>Объект</strong> считается опубликованным. Если снять флажок и сохранить карточку <strong>Объекта</strong>, то выбрать такой <strong>Объект</strong> в <strong>Заявке</strong> будет нельзя. Такой <strong>Объект</strong> считается необпубликованным. Неопубликованные <strong>Объекты</strong> нельзя выбирать в <strong>Заявках</strong>, таким образом можно предотвратить ошибочную подачу <strong>Заявок</strong> на еще не введенные в эксплуатацию объекты и оборудование. Чтобы опубликовать <strong>Объект</strong>, необходимо нажать кнопку <strong>Опубликовать</strong> в правом верхнем углу формы.</li>
     <p>
        <div>
            <img style="margin: 0 auto; display: block; max-width: 80%;"
