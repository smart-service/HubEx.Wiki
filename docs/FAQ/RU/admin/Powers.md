...
<ol>
    ...
    !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! ПОЛЬЗОВАТЕЛИ И КОНТАКТЫ ПРОПУСТИЛА!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    ...
    <li>Автоматическое назначение заявок: блок предназначен для настройки доступа к пункту меню консоли
        ...
        <ul>
            ...
            <li>Изменение правила выбора исполнителя:
            </li>
            <li>Создание правила выбора исполнителя
            </li>
            <li>Копирование правила выбора исполнителя
            </li>
            <li>Удаление правила выбора исполнителя
            </li>
