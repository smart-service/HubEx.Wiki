...
description: >-
  Для того, чтобы обратиться в поддержку в web-приложении, нажмите на знак
  вопроса в правом верхнем углу экрана. Вы можете самостоятельно ознакомиться с
  руководством пользователя (обучающими статьями) или написать сразу в чат
  поддержки.
