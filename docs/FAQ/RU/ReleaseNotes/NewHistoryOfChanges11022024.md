...
description: 'В заявке HubEx обновилась История изменений: фиксируются изменения по вкладкам «Заявка» и «Выполнение» — с датой, автором, старым и новым значением поля.'
keywords: 
