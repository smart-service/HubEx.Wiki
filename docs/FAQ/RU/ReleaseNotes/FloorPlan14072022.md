...
description: 'HubEx позволяет прикрепить план помещения к объекту и отмечать на нём точное место неисправности при подаче заявки в веб- и мобильном приложении.'
keywords: 
...
<p>Подробнее читайте в статье базы знаний: <a href="../user/FloorPlan.html">Планы помещений</a>.</p>
