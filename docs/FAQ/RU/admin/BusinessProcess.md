...
description: Пример бизнес-процесса заявки, пример базового жизненного цикла в Hubex
---
...
<p>Вы можете взять бизнес-процесс из данной статьи за основу в своей работе и внести различные корректировки в зависимости от потребностей вашего бизнеса. Определите, по каким стадиям должна пройти ваша Заявка и какие переходы допустимы между этими стадиями. </p>

<p>На рисунке представлены стадии Заявки на ремонт и последовательность перехода между ними.</p>

<div>
  <img  style="margin: 0 auto; display: block; max-width: 100%;" src="/attachments/images/FAQ/ADMIN/BusinessProcess/BasicStages.jpg" />
</div>

<p>Для настройки жизненного цикла необходимо создать Тип заявки, например, Заявка на ремонт и настроить переходы между стадиями. 
...
<p>Переход на стадию &laquo;Назначена&raquo; может быть настроен автоматически по прошествии какого-либо времени. Для этого используются правила выбора исполнителя. Подробно о настройке правил можно прочесть <a href="https://wiki.hubex.ru/docs/FAQ/RU/admin/RulesOfChoice.html">здесь</a>.</p>
...
<p>Либо здесь же в настройке <strong>Стадии</strong> можно отправить ее на другого исполнителя, согласно правилам выбора.&nbsp;Подробно о настройке правил можно прочесть <a href="https://wiki.hubex.ru/docs/FAQ/RU/admin/RulesOfChoice.html">здесь</a>.</p>
...
<td style="width: 374px;">
<p>Стадия помогает отличить заявки по котором уже проводились работы от тех, которые выполняются впервые.</p>
...
<td style="width: 374px;">
<p>Руководитель просматривает все заявки на стадии &laquo;Согласование&raquo; по сотрудниками и своевременно согласует выполнение работ.</p>
</td>
</tr>
</tbody>
</table>
