...
<li class="text-start ">Какие типы документов доступны.</li>
...
<h4 dir="auto">Правила отображения складов</h4>
...
<h3 dir="auto">Типы складских документов</h3>

<h4 dir="auto">📦 Оприходование</h4>

<p dir="auto">Фиксирует поступление материалов на склад. После проведения документа остатки материалов на выбранном складе обновляются.</p>

<p dir="auto">Подробная инструкция по созданию и проведению оприходования &mdash; в статье <strong><a href="../user/WarehousesGoodsReceipt.html" target="_blank" rel="nofollow">Оприходование</a></strong>.</p>

<h4 dir="auto">🚧 Списание <em>(скоро)</em></h4>

<p dir="auto">Документ для фиксации выбытия материалов со склада.</p>

<h4 dir="auto">🚧 Перемещение <em>(скоро)</em></h4>

<p dir="auto">Документ для переноса материалов между складами.</p>

<h4 dir="auto">🚧 Инвентаризация <em>(скоро)</em></h4>

<p dir="auto">Документ для сверки фактических остатков с учётными данными.</p>
...
<li class="text-start "><a href="../user/WarehousesGoodsReceipt.html" target="_blank" rel="nofollow">Оприходование</a></li>
...
<li class="text-start "><a href="../user/InventoryAccounting.html" target="_blank" rel="nofollow">Складской учет в HubEx: два сценария управления складом</a></li>
