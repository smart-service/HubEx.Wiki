...
description: >-
  Отчет по сотрудникам в HubEx дает возможность проанализировать данные,
  собранные по Сотрудникам и Заявкам. С помощью этих визуализаций вы сможете
  ответить на вопросы - Как загружены ваши сотрудники? Кто из исполнителей чаще
  других закрывает Заявки с нарушением срока?
keywords: >-
  отчет по сотрудникам, sla, показатели по сотрудникам, нарушение срока,
  просрочка заявок, нарушения sla, эффективность исполнителей, эффективность
  сотрудников, переработки, отработанное время, hubex рейтинг, хабекс рейтинг,
...
<p>Представление панели отчетов основывается на данных, собранных по <Strong>Заявках</Strong> в разрезе <Strong>Сотрудников</Strong>.
    ...
    Подробнее читайте в статьях: <a
        ...
        системы</a>, <a
            href="./CreatingTicket.html">Создание заявки</a>.
</p>
...
<ol>
    ...
    <li><Strong>Рейтинг</Strong> - средний рейтинг по всем специалистам. Подробнее читайте в статье: <a
            href="./Rating.html">Оценка заявок и рейтинг сотрудников</a>.
    </li>
</ol>
...
<ol>
    <li><strong>Отработано всего</strong> (в часах) - сумма рабочего времени исполнителей по выполненным работам,
        ...
        Подробнее читайте в статье: <a href="./AttachingFiles.html">Прикрпеление
            выполненных работ</a>;
    </li>
...
<ul>
    <li>Гистограмма <strong>Выполненные работы и переработки</strong> отображает количество отработанных часов (синие
        ...
        <p>Для корректного отображения данных необходимо устанавливать графики работ в карточке
            ...
            читайте в статье: <a
                    href="./Schedule.html">График работы исполнителей</a>.</p>
    </li>
