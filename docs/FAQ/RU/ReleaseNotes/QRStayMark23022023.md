...
description: 'В HubEx появилось подтверждение пребывания на объекте по QR-коду: исполнитель сканирует код перед переводом заявки на стадию «В работе».'
keywords: 
...
<div><img style="margin: 0 auto; display: block; max-width: 100%;" src="/attachments/images/FAQ/RELEASENOTES/QRStayMark23022023/1.png" width="750" height="auto" /></div>
