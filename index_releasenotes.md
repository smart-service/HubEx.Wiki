...
<h4><a href="https://wiki.hubex.ru/docs/FAQ/RU/ReleaseNotes/ListOfChanges05032026.html">Карточный список заявок: настройка карточек под себя, История изменений в заявках: только современное представление от 05.03.2025</a></h4>
<h4><a href="https://wiki.hubex.ru/docs/FAQ/RU/ReleaseNotes/ListOfChanges02032026.html">Редактор чек-листов удобный выбор объектов с поддержкой иерархии, Плагины в HubEx: теперь доступны прямо из верхнего меню от 02.03.2025</a></h4>
<h4><a href="https://wiki.hubex.ru/docs/FAQ/RU/ReleaseNotes/ListOfChanges02022026.html">Исправлена логика переноса трудоустройств при изменении типа пользователя, Расширена история изменений в заявках: теперь логируются материалы, дочерние заявки и акты, Безопасное удаление стадий заявок с проверкой на использование, Новая кнопка «Восстановить по умолчанию» в настройке формы заявки, Оптимизация: планы помещений загружаются только при наличии прав от 02.02.2025</a></h4>
