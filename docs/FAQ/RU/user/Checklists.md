...
<h5 id="checklistmob">Заполнение Чек-листа в Заявке в мобильном приложении инженера</h5>
...
<p>При отсутствии подключения к сети в приложении отображается нескрываемое уведомление <strong>Нет подключения к
    интернету</strong>. В
    этом случае вы все равно можете заполнить <strong>Чек-лист</strong>. Для этого откройте <strong>Заявку</strong> и <a
            href="#checklistmob">перейдите к Чек-листам</a>.
</p>
...
<p></p>
<p>Дополнительно ознакомьтесь с кратким видеороликом <strong>Чек-листы в HubEx: контролируйте качество работ, обучайте
    новых сотрудников</strong> об использовании чек-листов в HubEx.</p>
