---
title: "\U0001F527 1. Создание шаблона печатной формы"
description: 'В HubEx появился конструктор отчётов: пользователи сами создают шаблоны печатных форм с переменными из заявки, объекта и компании и распечатывают их.'
keywords: 
...
<p class="" data-start="3165" data-end="3344">Инструкции по работе с конструктором печатных форм можно посмотреть <a href="../user/PrintingFormDesigner.html" target="_blank" rel="noopener">здесь</a></p>
