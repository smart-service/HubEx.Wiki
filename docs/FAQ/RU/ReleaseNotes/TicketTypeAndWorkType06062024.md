...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../admin/TicketType.md" target="_blank">Типы заявок</a>.</p>
