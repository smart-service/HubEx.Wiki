...
<ul>
    ...
    <li>флажок <strong>Разрешить создавать заявки по этому объекту</strong> делает <strong>Объект</strong> доступным для выбора в <strong>Заявке</strong>. Такой <strong>Объект</strong> называется публичным. Если снять флажок и сохранить карточку <strong>Объекта</strong>, то выбрать такой <strong>Объект</strong> в <strong>Заявке</strong> будет нельзя. Такой <strong>Объект</strong> называется непубличным. Неопубликованные <strong>Объекты</strong> нельзя выбирать в <strong>Заявках</strong>, таким образом можно предотвратить ошибочную подачу <strong>Заявок</strong> на еще не введенные в эксплуатацию объекты и оборудование. Чтобы сделать непубличный <strong>Объект</strong> публичным, необходимо нажать кнопку <strong>Опубликовать</strong> в правом верхнем углу формы.</li>
     <p>
        <div>
            <img style="margin: 0 auto; display: block; max-width: 80%;"
