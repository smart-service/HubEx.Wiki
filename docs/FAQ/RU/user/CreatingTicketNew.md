...
<ul>
    ...
    <li><strong>Адрес</strong>: заполняется автоматически по адресу родительского объекта, но вы можете изменить его вручную.</li>
        <p><strong>Обратите внимание!</strong> Если в карточке выбранного <strong>Объекта</strong> установлен флажок <strong>Мобильное оборудование</strong>, то при изменении адреса в <strong>Заявке</strong> адрес изменится и в карточке этого Объекта.</p>
