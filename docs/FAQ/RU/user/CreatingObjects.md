...
<p>При создании нового <strong>Объекта</strong> на форме находится флажок <strong>Разрешить подавать заявки по этому объекту</strong>.
    ...
    <p>Если вы создаете неопубликованные <strong>Объекты</strong>, которые в данный момент не обслуживаете или которые нуждается в дальнейшем
    редактировании, то опубликовать можно
