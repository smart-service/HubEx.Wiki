...
<ul>
    ...
    <li>Визуализация <strong>Зависимость нарушений SLA от среднего количества открытых заявок</strong>
        ...
        <ol>
        <li><strong>Среднее кол-во открытых заявок</strong>
            - это среднее
            количество <strong>Заявок</strong> в день, которые назначены на специалиста, т.е. его загрузка; </li>
        
        <li><strong>% закрытых заявок с
            ...
            тем больше исполнитель закрыл <strong>Заявок</strong>.</li>
        </ol>
<div>
