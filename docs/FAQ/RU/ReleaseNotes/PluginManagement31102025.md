...
description: >-
  Добавили возможность управлять настройками прав доступа к плагинам для разных
  ролей пользователей
...
<ul>
<li>
<p class="ds-markdown-paragraph">&nbsp;<strong>Новый плагин добавлен</strong>&nbsp;&rarr; автоматически появляется в настройках всех ролей (выключен по умолчанию)</p>
</li>
<li>
