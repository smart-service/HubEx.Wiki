...
<h2 id="object1">Что такое "Объект/Оборудование" в HubEx</h2>
...
<h2 id="object2">Основные поля</h2>
...
<h2 id="object3">Что представляет собой список объектов/оборудования</h2>
...
<h2 id="object4">Раздел объекта "Контактные лица"</h2>
...
<h2 id="object5">Функционал "Мобильное оборудование"</h2>
...
<h2 id="object6">Функционал "Планы помещений"</h2>
...
<h2 id="object7">Раздел объекта "QR-коды" (функционал "Приемка и маркировка")</h2>
...
<h2 id="object8">Раздел объекта "Дополнительные поля"</h2>
...
<h2 id="object9">Раздел объекта "Дочерние объекты"</h2>
...
<h2 id="object10">Раздел объекта "История обслуживания"</h2>
...
<h2 id="object11">Для интеграций (дополнительно)</h2>
