...
<body>
<p>Мы рады представить вам новые возможности для оптимизации работы в HubEx! Теперь вы легко&nbsp;сможете найти необходимые <strong>Заявки</strong>, самостоятельно настроив удобное расположение фильтров для списка <strong>Заявок!</strong></p>
<h5>Настройка расположения фильтров</h5>
<p>Как вы уже знаете, список <strong>Заявок</strong> можно фильтровать, используя как основные, так и дополнительные поля в <strong>Заявках</strong>. Дополнительные поля создаются и настраиваются в консоли администратора. Подробнее про создание Дополнительных полей читайте в статье: <a href="https://wiki.hubex.ru/docs/FAQ/RU/user/AdditionalFields.html">Создание дополнительных полей для заявки.</a></p>
...
<p>Таким образом вы сможете быстро и эффективно находить&nbsp;<strong>Заявки</strong>, скрывая те параметры фильтрации, которые вам не нужны.</p>
