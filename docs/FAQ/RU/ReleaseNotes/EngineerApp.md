...
<p>Добавлена возможность указать месторасположение проблемы на плане помещения. Подробнее читайте в статье базы знаний: <a href="../user/FloorPlan.md">Планы помещений</a>.</p>

<p>Обновлен и доработан функционал <strong>На смене</strong>. Подробнее читайте в статье базы знаний: <a href="../user/OnDuty.md">Индивидуальный график работы: функционал На смене</a>.</p>
...
<p>Подробнее читайте в статье базы знаний: <a href="../user/Messages.md">Сообщения по заявке</a>.</p>
...
<p>Подробнее читайте в статье базы знаний: <a href="../user/ObjectEditing.md">Редактирование данных объекта (оборудования)</a>.</p>
...
<p>Подробнее читайте в статье базы знаний: <a href="../user/ActOFAcceptance.md">Акт выполненных работ</a>, <a href="../user/AttachingFiles.md">Прикрепление выполненных работ в web и мобильном приложении</a>.</p>
...
<p>Подробнее читайте в статье базы знаний: <a href="../user/CreatingTicket.md">Создание заявки</a>, <a href="../user/AttachingFiles.md">Прикрепление выполненных работ в web и мобильном приложении</a>.</p>
...
<p>Подробнее читайте в статьях базы знаний: <a href="../user/Schedule.md">График работы исполнителей</a>, <a href="../user/CreatingTicket.md">Создание заявки</a>.</p>
...
<p>Подробнее читайте в статьях базы знаний: <a href="../user/CreatingTaskTemplates.md">Создание шаблона заявки, подача заявки по QR-коду</a>, <a href="../user/CreatingObjects.md">Создание обслуживаемого оборудования</a>.</p>
...
<p>Подробнее читайте в статье базы знаний: <a href="../user/Rating.md">Оценка заявок и рейтинг сотрудников</a>.</p>

<h5>Версия 1.58.01 от 13.05.2019</h5>
<p>Добавлена функция трекинга мобильного исполнителя. Улучшена работа с локациями.</p>
<p>Подробнее читайте в статьях базы знаний: <a href="../user/GEOinMob.md">Геолокация в мобильном приложении исполнителя</a>, <a href="../user/GeoPosition.md">Карта: текущая геопозиция сотрудников</a>.</p>
...
<p>Подробнее читайте в статьях базы знаний: <a href="../user/AttachingFiles.md">Прикрепление выполненных работ в web и мобильном приложении</a>, <a href="../user/Checklists.md">Чек-листы</a>.</p>
