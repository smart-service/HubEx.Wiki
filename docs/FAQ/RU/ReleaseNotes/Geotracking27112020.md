...
description: 'Новый отчёт «История перемещений» на карте HubEx показывает маршруты сотрудников, время в пути, на заявке и на остановках за выбранный период.'
keywords: 
...
<p>Подробнее об отчете читайте в статье базы знаний: <a href="../user/Geotracking.html">Историй перемещений</a>.</p>
