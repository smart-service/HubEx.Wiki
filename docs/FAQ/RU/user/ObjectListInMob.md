...
description: В мобильном приложении HubEx исполнитель для пользователя доступен список Объектов и Оборудования. Доступ к Объектам регулируется настройками Роли пользователя в консоли администрирования.
...
<p>В паспорте объекта пользователь может изменить некоторые характеристики: <strong>Класс
    ...
    <a href="./ObjectEditing.html">Редактирование данных Объекта (Оборудования)</a>.
</p>
