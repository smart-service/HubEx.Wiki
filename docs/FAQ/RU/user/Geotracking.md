...
<p>Система отберет данные по всем <Strong>Заявкам</Strong>, которые попадают в заданный в отчете промежуток времени.  Также вы увидите общий пробег по исполнителям, время и сами <Strong>Заявки</Strong>. Обратите внимание! Если вы укажете дату позднее даты обновления
    отчета, то эти данные в отчете не отобразятся. </p>
<div>
