---
title: >-
  Поиск заявок по текстовому полю по компаниям, Вывод времени создания заявки в
  МП
description: >-
  Добавили возможность поиска заявок по текстовому полю по компаниям - Заказчик,
  получатель платежа (наша компания); Доработали выводи времени создания в самой
  заявки в МП
