...
<h5 id="webmess">Создавать сообщения в WEB-приложении: </h5>
...
----
<h5 id="mobmess">Создавать сообщения в мобильном приложении: </h5>
...
<h5 id="chatadd">Добавлять и удалять собеседников в чат по заявке: </h5>
