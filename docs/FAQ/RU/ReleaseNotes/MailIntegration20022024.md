...
<p>В статье нашей базы знаний&nbsp;<a href="../admin/TicketMail.md" target="_blank" rel="noopener">Интеграция по электронной почте, подача заявок по электронной почте</a> мы подробно рассказываем, как настроить пересылку для ящиков Gmail и Yandex. После настройки интеграции по пересылке письма будут трансформироваться в <strong>Заявки</strong> системы HubEx.</p>
