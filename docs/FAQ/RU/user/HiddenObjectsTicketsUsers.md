...
description: >-
  Заказчик создал Заявку, но ее не видно в общем списке, или исполнитель в
  мобильном приложении создал новую Заявку, а диспетчер в web приложении ее не
  видит. Пользователь создает Заявку, но не может найти в справочнике нужный
  Объект. Как можно решить эти проблемы рассмотрим в данной статье.
keywords: >-
  не видно заявки, не отображаются объекты, не видно объекты, не отображатся
  исполнители, не видно в списке, справочник заявки, справочник объекты, hubex,
