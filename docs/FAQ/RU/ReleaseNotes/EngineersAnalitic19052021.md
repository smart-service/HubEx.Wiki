...
<p>В меню Аналитика теперь доступен Отчет по сотрудникам. Представление панели отчетов основывается на данных в Заявках в разрезе Сотрудников.</p>
<h2>Отчет по сотрудникам</h2>
<p>С помощью Отчета по сотрудникам вы получаете данные по вашим исполнителям: количество закрытых Заявок, закрытые Заявки с нарушением срока, время всех выполненных работ и переработок, рейтинги, показатели эффективности и т.д.</p>
...
<ul>
<li>Заявки и SLA : здесь вы узнаете все о количестве закрытых и незакрытых Заявок, о количестве закрытых Заявок с нарушением SLA, где SLA - показатель качества&nbsp; &nbsp; предоставляемых услуг, основывающийся на времени исполнения (закрытия) Заявки.
<p>Вы сможете определить сотрудников, которые сильно перегружены Заявками и не успевают их закрывать, оценить, кто из сотрудников чаще других переназначает с себя Заявки на других исполнителей и т.д.</p>
</li>
</ul>
...
<ul>
<li>Отработанное время: на этой странице представлены графики и таблицы с показателями по отработанному и переработанному времени.
