...
Консоль администрирования предназначена для настройки работы пользователей: создания ролей, участков, настройки жизненного цикла заявки, добавления дополнительных полей, настройки уведомлений и т.д. Ознакомьтесь с нашим обучающим роликом <a href="https://youtu.be/5qsg9aUpIlw"target="_blank">"Консоль администратора в HubEx". В нем мы рассказываем обо всех возможностях консоли.
