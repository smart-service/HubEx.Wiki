...
<ul>
    <li><a href="#first">Группу отчетов и показателей по выявлению проблем в бизнес-процессах;</a></li>
...
<p>HubEx предназначен для улучшения бизнес-процессов. Внедрение системы управления заявками и мобильными сотрудниками
    ...
    С помощью аналитических отчетов вы можете оценить показатели сотрудников, проанализировать время выполнения <strong>Заявок</strong> и
...
<h5 id="first">Группа отчетов и показателей по выявлению проблем в бизнес-процессах</h5>
...
<p>В рамках данного аналитического отчета под процессом подразумевается последовательность прохождения
    ...
    переход по стадиям <strong>Новая - Назначена - Не принята исполнителем - Назначена - В работе - Выполнена -
        ...
        <p>Обратите внимание, что на вкладках <strong>Выявление проблем в бизнес-процессах</strong> и <strong>Сравнение эфеективности процессов</strong> рассматриваются только закрытые <strong>Заявки</strong>. Для того, чтобы определить процесс, он должен быть завершен.</p>
...
<ol>
    ...
    <li><Strong>Количество переходов по стадиям</Strong> - по умолчанию для отчета настроено ограничение в отображении до 30.000 переходов. Если вам необходимо видеть больше переходов, напишите нам в Чат с
...
<p>В диаграмме <strong>Выявление неоптимальных вариантов процесса прохождения заявок по стадиям</strong> находится
    ...
    рамках этих
    процессов превышает среднее время выполнения <strong>Заявок</strong> по организации и количество <strong>Заявок</strong> также существенное. </p>
...
<p>Например, <strong>Процесс №1</strong> включает в себя 7 <strong>Заявок</strong>, каждая из которых выполнялась в
    ...
    что превышает показатель <strong>Среднего времени выполнения заявок</strong> по организации (8 дней 20 часов). </p>
