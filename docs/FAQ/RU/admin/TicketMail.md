...
<ul>
    ...
    <div>
        <img style="margin: 0 auto; display: block; max-width: 90%;"
             src="/attachments/images/FAQ/ADMIN/TicketMail/EmailSettings.png"/> </div>
    </p>
    

    <li><strong>Шаг 2:</strong>: отключите двухфакторная аутентификация или безопасный вход для почтового ящика. Для отключения
