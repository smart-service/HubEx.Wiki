...
description: >-
  При создании Заявки или при открытии Заявки на какой-либо стадии пользователь
  может увидеть форму Заявки, на которой нет никаких полей. Это происходит в
  случае, когда создали новую Стадию заявки и добавили ее в жизненный цикл, но
  забыли настроить доступ к полям на форме заявки - отображение и возможность
  редактировать различных полей в Заявке на разных стадиях для различных ролей.
