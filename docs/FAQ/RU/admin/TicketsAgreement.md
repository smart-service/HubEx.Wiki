...
<h5 id="customeragreement1">1.2. Стадии заявки и настройка жизненного цикла</h5>
...
<h5 id="message1">1.3. Настройка оповещений</h5>
...
<h5 id="customeragreement2">2.2. Стадии заявки и настройка жизненного цикла</h5>
...
<h5 id="message2">2.3. Настройка оповещений</h5>
...
<p>Оба ответственных за согласование (Ответственный по закупкам и Начальник подразделения) получают сообщение на
    электронную почту в
...
<p>Далее один из ответственных открывает Заявку (например, первым будет Начальник подразделения) и переводит ее либо на
...
<p>В случае, когда первый ответственный согласовал Заявку, второму (Ответственному по закупкам) приходит уведомление, о
    том, что первый ответственный уже согласовал Заявку и требуется решение второго. </p>
...
<p>Второй ответственный также открывает Заявку (например, вторым будет Ответственный по закупкам) и переводит ее либо на
