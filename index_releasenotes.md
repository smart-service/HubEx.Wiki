...
<!-- <h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges01072026.md">Понятная ошибка при входе без интернета, Исправлен ввод количества материалов в выполненной работе, Повышена стабильность создания выполненных работ в МП от 01.07.2026</a></h4> -->
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges18062026.md">Ручное создание складов и материалов в Панели диспетчера от 18.06.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges08062026.md">Вставка изображений в описание заявки, Настройка стартовой страницы для пользователей (веб-версия) от 08.06.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges25052026.md">Множественный поиск по объектам: теперь можно искать по списку за раз 25.05.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges12052026.md">Новые настройки точности сбора геокоординат для мобильных сотрудников, Улучшенные подсказки об ошибках в мобильном приложении, Быстрые фильтры для заявок теперь доступны в мобильном приложении от 12.05.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges27042026.md">Просмотр заявок из списка в боковом окне, Дополнительные поля-справочники для выполненных работ (ВР) в МП и WEB от 27.04.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges16042026.md">Сканирование Data Matrix в МП — Этап 2: Контроль списания маркируемых материалов от 16.04.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges13042026.md">Предпросмотр PDF-файлов в веб-версии HubEx, Кастомный паспорт объекта для QR-кодов от 13.04.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges06042026.md">Множественный поиск по дополнительным полям объектов, Упрощённый вход после создания пароля от 06.04.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges30032026.md">Множественный поиск по заявкам в веб-версии HubEx, Сканирование Data Matrix для маркированных материалов в мобильном приложении HubEx (Этап 1), Новый функционал «История перемещений» в разделе «Карты» от 31.03.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges16032026.md">Чек-листы HubEx: поддержка дополнительных полей-справочников в МП и WEB, Редактирование выполненных работ (ВР) в офлайн-режиме стало доступно от 23.03.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges05032026.md">Карточный список заявок: настройка карточек под себя, История изменений в заявках: только современное представление от 05.03.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges02032026.md">Редактор чек-листов удобный выбор объектов с поддержкой иерархии, Плагины в HubEx: теперь доступны прямо из верхнего меню от 02.03.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges02022026.md">Исправлена логика переноса трудоустройств при изменении типа пользователя, Расширена история изменений в заявках: теперь логируются материалы, дочерние заявки и акты, Безопасное удаление стадий заявок с проверкой на использование, Новая кнопка «Восстановить по умолчанию» в настройке формы заявки, Оптимизация: планы помещений загружаются только при наличии прав от 02.02.2026</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges24122025.md">Новая возможность: настройка размера шрифта в мобильном приложении HubEx, Техническое обновление: Увеличен лимит длины параметров запроса от 22.12.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges16122025.md">Обновление Глобальное управление видимостью дополнительных полей заявок, Улучшенная работа с картой: новый переключатель кластеризации заявок, Фильтры теперь работают на вкладке «Неназначенные» на карте, Ручной офлайн режим в МП от 18.12.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges20112025.md">Обновление Расширенные возможности фильтрации объектов и оборудования, Плановые трудозатраты в видах работ теперь учитываются в минутах, В HubEx появились два новых раздела в меню от 25.11.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/PluginManagement31102025.md">Новая система управления доступом к плагинам в ролях пользователей от 31.10.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/UserAddetionFields23102025.md">Обновления HubEx: чек-листы, гиперссылки в календаре, пользовательские поля, фильтрация заявок, редактирование заявки в офлайн от 23.10.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges06102025.md">Обновление Новые возможности фильтрации: поля-переключатели в заявках и Новые настройки отслеживания местоположения для мобильных сотрудников от 06.10.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/CustomizableTaskForm25092025.md"> Новый функционал - Настраиваемая форма заявки от 25.09.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges15092025.md">Обновление Улучшенный поиск по заявкам: теперь и по компаниям, Теперь в мобильном приложении отображается время создания заявки от 15.09.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges09092025.md">Обновление Автоматическая привязка видов работ к типам оборудования, Новые виджеты в Панели управления администратора от 09.09.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges02092025.md">Обновление Системные справочники в дополнительных полях для Договоров и Компаний, Управление материалами в HubEx от 02.09.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges26082025.md">Визуализация жизненного цикла заявок, Обновление процесса регистрации в соответствии с требованиями защиты данных от 25.08.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ListOfChanges18082025.md">Создание вебхуков по объектам, новый дизайн страницы сотрудника и заказчика от 18.08.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/Drawing28072025.md">Дополнительное поле “Рисунок” для подписей: обновление от 28.07.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/ManageRightsForBulkEditing28072025.md">Управление правами для массового редактирования от 28.07.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/IntegrationBitrix24-23072025.md">HubEx теперь интегрируется с Битрикс24 - обновление от 23.07.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/NewDomainRoutingSystem14072025.md">Новая система маршрутизации по доменам - от 14.07.2025</a></h4>
<h4><a href="./docs/FAQ/RU/ReleaseNotes/NewFeaturesTaskChangeHistory11072025.md">Улучшенная история изменений с геоданными и новыми возможностями от 11.07.2025</a></h4>
