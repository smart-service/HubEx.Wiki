...
- Если вы дополняете шаблоны, которые до этого экспортировали, не забывайте своевременно загружать действующие версии, так как при внесении каких-либо изменений в действующие данные, а потом импорте данных с устаревшего шаблона, система не распознает данные и выдаст ошибку.
