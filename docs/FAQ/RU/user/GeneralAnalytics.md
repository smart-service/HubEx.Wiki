...
description: >-
  Общая аналитика в HubEx дает возможность проанализировать данные, собранные по
  Заявкам. С помощью этих визуализаций вы сможете ответить на вопросы -
  справляется ли сервисная служба с потоком поступающих Заявок? кто из
  исполнителей не выдерживает сроки закрытия Заявок и закрывает их с просрочкой?
  нужно ли нанять еще специалиста по определенному виду работ или справляется
  текущий, который работает по совместительству?
keywords: >-
  общая аналитика, панель отчетов, ключевые показатели эффективности, динамика
  поступивших заявок, аналитические разрезы по заявкам, круговые диаграммы
  распределения заявок, hubex, хабекс, хубекс, хабикс
category: user
---
...
<p>В левом верхнем углу отчета можно задать период для формирования отчета. С помощью панели <Strong>Фильтров</Strong> (справа) вы можете выбрать <Strong>Тип заявки</Strong>, <Strong>Участок</Strong> и т.д. Данный фильтр
...
<p>Представление панели отчетов основывается на данных в <Strong>Заявках</Strong>. </p>
...
<ol>
    ...
    <li>Средняя оценка клиентов влияет на продолжительность сотрудничества с вашими клиентами.
        <p>Рейтинг выставляется в рамках каждой <Strong>Заявки</Strong>. Если рейтинг не используется, то в отчете будет установлен прочерк. Подробнее читайте в статье: <a
                href="./Rating.html">Оценка заявок и рейтинг
            сотрудников</a>.</p>
...
<p>С данным отчетом рекомендуется работать в специальном режиме фокусировки, который открывается по кнопке <Strong>Режим
...
<p>Для добавления характеристики для анализа нажмите + и выберите из списка необходимый разрез.</p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 40%;"
         src="/attachments/images/FAQ/USER/GeneralAnalitics/Analitics3.jpg"/>
</div>

<p>Например, вы можете выяснить, кто из исполнителей закрывает срочные (критичные) <Strong>Заявки</Strong> с просрочкой. Сделать это
...
<p>Для сброса характеристики нажмите крестик у той, которую хотите отменить.</p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 95%;"
...
___
### Следующие шаги:
- [Срез по заявкам](./TicketsReport.html)
- [Отчет для клиента](./ClientsAnalytics.html)
- [Отчет по объектам обслуживания](./ObjectsAnalytics.html)
