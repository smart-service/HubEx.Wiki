...
### Мобильное приложение HubEx заказчик
С помощью мобильного приложения <strong>HubEx заказчик</strong> ваши заказчики могут создавать Заявки, отслеживать их выполнение, подписывать акты выполненных работ и оценивать работу исполнителей.
