...
description: 'Обновлённая карточка компании в HubEx: категории заказчик/подрядчик, юридические реквизиты по типу организации и контактные данные с несколькими лицами.'
keywords: 
