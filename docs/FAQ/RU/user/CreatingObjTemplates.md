...
<p>Готовые QR-стикеры, которыми вы можете промаркировать ваши объекты, теперь можно заказать в web-приложении по кнопке
    <strong>QR-стикеры
        на вашем оборудовании</strong>. Вы получите уникальные стикеры, брендированные вашим логотипом, которые сможете
    распечатать и наклеить на обслуживаемое оборудование. </p>
<div>
