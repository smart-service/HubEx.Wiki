...
<ol>
    ...
    <li id="objecttemplate"><Strong>Шаблоны объектов</Strong>: блок предназначен для настройки доступа к пункту web-приложения <Strong>Объекты|Оборудование - Шаблон
        ...
        <ul>
            ...
            <li><Strong>Создание шаблона объекта</Strong>: при включении полномочия в меню Чек-листы появится кнопка <Strong>Создать шаблон</Strong>;
            </li>

            <li><Strong>Удаление шаблона объекта</Strong>: при включении полномочия в меню <>Объекты|Оборудование - Шаблон объектов и
                оборудования</Strong> в контекстном меню (три точки) появится пункт <Strong>Удалить</Strong>;
            </li>

            <li><Strong>Копирование шаблона объекта</Strong>: при включении полномочия в меню <>Объекты|Оборудование - Шаблон объектов и
