...
<ul>
<li>
<p class="ds-markdown-paragraph"><strong>Использование переменных:</strong>&nbsp;Вы можете добавлять в макет любые данные из системы, используя доступный набор переменных (например,&nbsp;<code>{{Тип заявки}}</code>,&nbsp;<code>{{Компания-заказчик | Название компании}}</code>).</p>
</li>
<li>
