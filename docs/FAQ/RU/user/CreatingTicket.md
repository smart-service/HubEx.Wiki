...
Для того чтобы выгрузить всю информацию по заявкам из системы HubEx, существует функция "Экспорт". Подробнее про неё читайте [здесь](https://wiki.hubex.ru/docs/FAQ/RU/user/Export.html).
