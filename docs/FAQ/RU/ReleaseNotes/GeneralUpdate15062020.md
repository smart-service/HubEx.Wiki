...
description: 'Обновление HubEx: создание заказчиков и объектов прямо из формы заявки, повторная отправка приглашений и новое правило автоназначения исполнителей.'
keywords: 
