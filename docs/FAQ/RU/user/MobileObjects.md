...
description: >-
  Мобильное оборудование - это оборудование, адрес которого может изменяться.
  Новый адрес такого оборудования можно указывать прямиком в Заявке и он будет
  сохраняться автоматически в карточке Объекта.
...
<p>Посмотреть историю перемещений такого оборудования вы можете с помощью экспорта <strong>Заявок</strong> с отбором по этому оборудованию. Подробнее читайте в статье: <a href="./Export.html">Экспорт</a>.</p>
