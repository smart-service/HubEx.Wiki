...
В мобильном приложении Исполнителя у сотрудника есть возможность отслеживать доступные ему склады и материалы на вкладке с одноименным названием, на которую можно перейти через боковое меню.
