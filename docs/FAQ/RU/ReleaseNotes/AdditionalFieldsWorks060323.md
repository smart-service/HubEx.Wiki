...
description: 'Дополнительные поля теперь доступны и для выполненных работ в HubEx — где их настроить и как они выглядят в приложениях.'
keywords: 
...
<p>Подробнее читайте в статье базы знаний: <a href="../user/AdditionalFields.html">Создание дополнительных полей</a>.</p>
