...
description: С помощью отчета Анализ эффективности процессов вы сможете отследить проблемные места в бизнес-процессах сервисных организаций; оценить эффективность внесенных изменений в процессы после обнаружения и исправления проблем.
...
<p>Обратите внимание, что на вкладках <strong>Выявление проблем в бизнес-процессах</strong> и <strong>Сравнение
    эффективности процессов</strong> рассматриваются только закрытые <strong>Заявки</strong>. Для того чтобы
    рассматривать
...
<p>Выберем процесс с наибольшим временем выполнения и с большим количеством <strong>Заявок</strong> для дальнейшего
    анализа.</p>
<p>Например, <strong>Процесс №1</strong> включает в себя 40 <strong>Заявок</strong>, каждая из которых выполнялась в
    среднем 25 дней 11 часов,
    что превышает показатель <strong>Среднего времени выполнения заявок</strong> по организации (11 дней 17
    часов). </p>
...
<p>С помощью этой визуализации вы можете конкретнее отфильтровать проблемную группу/группы
    <strong>Заявок</strong>. Например, выбрать группы 1 и 2, т.к. их время выполнения Заявок более. Чтобы
    выбрать несколько
    групп, удерживайте зажатой клавишу Ctrl и нажимайте на группы по очереди. Выбирать группы не обязательно. </p>
...
<p>Далее можно перейти к анализу <strong>Схемы прохождения заявок по стадиям</strong>.</p>
<p>Схема отображает процессы прохождения <strong>Заявок</strong> от создания до закрытия.</p>
<p>По умолчанию, когда нет отбора по процессам, схема отображает все варианты закрытия <strong>Заявок</strong>.</p>
<p>Яркость соединительных линий зависит от среднего времени перехода от одной стадии к другой. Также на линии
    отображается количество <strong>Заявок</strong>, перешедших от одной стадии к другой и среднее время перехода на
    стадию.</p>
<p>Количество вариантов процесса закрытия <strong>Заявок</strong> на общей схеме можно регулировать с помощью зеленого
    ползунка: если перемещать его влево, то схема отобразит наиболее встречающийся процесс прохождения
    <strong>Заявок</strong>, если переместить вправо, то отобразятся все процессы. </p>
<p>Также можно увеличивать масштаб схемы с помощью кнопок приближения и отдаления.</p>

<div>
    <img style="margin: 0 auto; display: block; max-width: 100%;"
         src="/attachments/images/FAQ/USER/ProcessEfficiency/Main.jpg"/>
</div>

<p>Далее будем рассматривать схему, отфильтрованную по <strong>Процессу №1</strong> из таблицы.</p>
<p>Разверните схему по кнопке
    <strong>Режим
...
<p>В примере обратите внимание на стадию <strong>Отказ
    заказчика</strong>, переход на которую со стадии <strong>Согласование</strong> занял 25 дней. Возможно,
    заказчику не хватало данных, чтобы быстро согласовать запланированный ремонт.</p>
...
<p> Здесь мы также видим, что стадия <strong>На согласовании</strong> заняла много
    времени в процессе
...
<p>В списке <strong>Заявок</strong> вы можете проанализировать их общие черты. Например, видим две
    <strong>Заявки</strong> по одному
...
<p>С помощью аналитических разрезов можно разбить выборку по различным характеристикам - <strong>Вид работ</strong>,
    ...
    чтобы ускорить принятие решений о согласовании новых ремонтов.</p>
<p>В текущем примере мы можем разбить
    <strong>Заявки</strong> по <strong>Типу объекта</strong>, чтобы определить проблемное оборудование. </p>
...
<p>Сбросим отбор по процессам и рассмотрим диаграмму <strong>Заявки с циклом в процессе</strong>. Она показывает
    соотношение <strong>Заявок</strong>,
    в маршруте
    прохождения которых
    была зацикленность по стадиям. Цикл означает прохождение <strong>Заявки</strong> через одну/несколько одинаковых
    стадий более, чем
    один раз. Видим, что есть 13,97% <strong>Заявок</strong> с циклом. Можно щелкнуть на сектор с зацикленными заявками,
    чтобы отфильтровать весь отчет.</p>
<p>И следом отфильтровать отчет по Процессу №1, который состоит из двух <strong>Заявок</strong> со средним временем
    выполнения 37 дней и 1 час.</p>
...
<p>Видим, что здесь ситуация связана со стадией <strong>Ожидает ТМЦ</strong> - ожидание запчастей для каждой <strong>Заявки</strong>
    заняло 19 дней и 2 часа. Далее эту ситуацию также можно рассмотреть через список Заявок, посмотреть каких именно
    запчастей пришлось ожидать так долго и предпринимать меры по оптимизации складских запасов, если это необходимо.</p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 100%;"
         src="/attachments/images/FAQ/USER/ProcessEfficiency/Diagram9-1.jpg"/>
</div>
...
<p>Например, с помощью этого отчета можно сравнить чем отличается процесс выполнения срочных <strong>Заявок</strong> от
    обычных. В таком
    случае можем выбрать значение <strong>Критичности</strong> для первого варианта - <strong>Высокая</strong>, для
    второго - <strong>Низкая</strong>.
</p>

<p>На примере видим, что среднее время выполнения срочных <strong>Заявок</strong> на 8 дней 17 часов меньше обычных. </p>
...
<p>Обратите внимание на процессы, на которые тратится больше времени, чем на остальные. </p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 100%;"
...
<p>Настроим необходимые фильтры и для варианта А выберем январь 2023, для варианта В – декабрь 2022.</p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 100%;"
...
<p>График будет отображать среднее время перехода от стадии <strong>Назначена</strong> до стадии <strong>Выполнена</strong>.
</p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 100%;"
...
___
### Следующие шаги:
- [Сервисный акт](./PrintedFormAct.html)
- [Карта: текущая геопозиция сотрудников](./GeoPosition.html)
- [История перемещений](./Geotracking.html)
