...
<ul>
    <li><strong>Вид компании</strong></li>
            <li>Компания-подрядчик - компания, взявшая на себя обязательства выполнить определенную работу по оказанию работ/услуг.;</li>
            <li>Компании-заказчики - компания, заинтересованная в выполнении работ/услуг нашей компанией или компанией-подрядчиком, как правило, выступает инициатором и потребителем работ/услуг.;</li>>
