...
description: 'Карты в HubEx переведены на Яндекс.Карты: обновлённый интерфейс выбора и редактирования адреса доступен в заявках, объектах, QR-кодах и компаниях.'
keywords: 
...
<body>
<p>Мы рады сообщить, что в нашем приложении теперь используются <strong>Яндекс.Карты</strong>! Это решение сделано для обеспечения максимально актуальной картографической информации.
