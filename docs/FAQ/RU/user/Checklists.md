...
Важным добавлением к чеклистам является возможность добавить атрибут "Вложенный файл", обычно таковым файлом является фотография. Добавив данный атрибут в чеклист, вы можете удостовериться, что сервисный специалист действительно выполнил работы по объекту, так как он будет обязан прислать фото-подтверждение.
<div>
