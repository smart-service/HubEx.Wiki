...
<ul>
    ...
    <li>Флажок <Strong>Показывать сотрудника на карте и учитывать время на стадии как рабочее</Strong> будет отображать сотрудника на карте на момент нахождения
        хотя бы одной <Strong>Заявки</Strong> на этом исполнителе на данной
        стадии. Также время на такой стадии будет учитываться как рабочее при построении аналитических отчетов. Например, устанавливать такой флажок на стадии <Strong>В пути</Strong> (или <Strong>Выезд специалиста</Strong>), <Strong>В работе</Strong> нужно обязательно, чтобы шел корректный учет времени, затраченного на заявку.
    </li>
