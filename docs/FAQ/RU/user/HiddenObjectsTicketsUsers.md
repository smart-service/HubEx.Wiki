...
description: Заказчик создал Заявку, но ее не видно в общем списке,
    или исполнитель в мобильном приложении инженера создал новую Заявку, а диспетчер в web приложении ее не видит. Пользователь создает Заявку, но не может найти в справочнике нужный Объект. Как можно решить эти проблемы рассмотрим в данной статье.
