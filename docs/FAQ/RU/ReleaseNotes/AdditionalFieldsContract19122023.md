...
description: 'В HubEx можно создавать дополнительные поля для карточек компаний и договоров и настраивать их в консоли администратора.'
keywords: 
...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/AdditionalFields.html" target="_blank">Дополнительные поля</a>. </p>
