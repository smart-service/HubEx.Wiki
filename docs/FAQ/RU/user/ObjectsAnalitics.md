...
<ul>
    ...
    <li><Strong>Соаздано заявок за период</Strong> - количество созданны <Strong>Заявок</Strong> по <Strong>Объекту</Strong>;</li>
...
<p id="maindynamic">На графике <Strong>Динамика количества поступивших, закрытых и незакрытых заявок</Strong> отображается количество поступивших, закрытых и открытых Зпявок за период. Вы можете изменять представление
...
<p id="maintable"><Strong>Таблица со списокм заявок</Strong> отображается в свернутом виде. Развернуть таблицу можно по нажатию на кнопку <Strong>Открыть
...
<ul>
    ...
    <li>параметр <Strong>Объектов</Strong> - показывает количество <Strong>Объектов</Strong> в процентном соотношении по <Strong>Типам оборудования/Классам
        оборудования</Strong>;
    </li>
...
<p>Карта показывает расположение <Strong>Объектов</Strong>, по которым за выбранный в отчете период, поступила хотя бы одна <Strong>Заявка</Strong>.
    Размер точек зависит от количества поступившх <Strong>Заявок</Strong>. </p>
