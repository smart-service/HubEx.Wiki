...
description: 'Плановые заявки теперь отображаются в календаре HubEx на месяц — на вкладке «Планировщик» видно дату и количество запланированных заявок.'
keywords: 
...
<p>Подробнее о создании плановых заявок и работе с календарем вы можете прочитать в статьях нашей базы знаний: <a href="../user/Calendar.html">Календарь заявок</a>, <a href="../user/PlannedTickets.html">Создание плановой заявки</a>.</p>
