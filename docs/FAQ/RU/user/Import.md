...
В системе HubEx помимо экспорта также существует и система импорта, с помощью неё Вы сможете внести информацию по Вашим заявкам, сотрудникам, объектам и компаниям.
...
![impwork1.png](/attachments/images/FAQ/USER/Import/impwork1.png)
