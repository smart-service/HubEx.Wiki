...
description: 'Боковая панель заявки в HubEx теперь открывается в календаре, истории обслуживания объекта, на карте и у дочерних заявок — без перехода в новую вкладку.'
keywords: 
...
<p>Боковая панель открывается справа и содержит в себе основные поля формы <strong>Заявки</strong>. Вы можете вносить необходимые изменения: заменить <strong>Вид работ</strong>, исправить <strong>Договор</strong>, назначить <strong>Исполнителя&nbsp;</strong>и даже прикрепить файлы.&nbsp;</p>
