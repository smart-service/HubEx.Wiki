...
description: 'В HubEx можно создавать и редактировать инициатора заявки прямо из её карточки, а также просматривать историю всех обращений выбранного инициатора.'
keywords: 
...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/UsersRequests.html" target="_blank">Инициатор заявки: создание инициатора, история обращений</a>.</p>
