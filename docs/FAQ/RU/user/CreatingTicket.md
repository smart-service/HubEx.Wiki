...
Для автоматической генерации номера Заявки вы можете настроить шаблон номера в консоли администрирования в меню Настройки заявки - Тип заявки. Подробнее читайте в статье <a href="">Типы заявок</a>.</li> -->
