...
<ol>
    ...
    <li>Пользователи и контакты: блок предназначен для настройки доступа к пункту меню web-приложения Пользователи для работы со справочниками Сотрудники и Заказчики.
        ...
        <ul>
            ...
            <li>Удаление сотрудников и заказчиков:
            </li>

            <li>Создание сотрудников и заказчиков
            </li>

            <li>Создание приглашений
            </li>

            <li>Удаление приглашений
            </li>

            <li>Копирование сотрудников и заказчиков:
            </li>

            <li>Изменение данных сотрудника или заказчика
            </li>

            <li>Копирование приглашений:
            </li>

            <li>Изменение приглашений:
            </li>

            <li>Экспорт сотрудников и заказчиков:
            </li>

            <li>Импорт сотрудников и заказчиков:
            </li>

            <li>Перевод сотрудника в заказчики
            </li>

            <li>Перевод заказчика в сотрудники
            </li>

            <li>Добавление контактов
            </li>
        ...
        <ul>
            ...
            <li>Заблокированные пользователи: пользователю станут доступны для работы Объекты, которые были удалены;</li>
