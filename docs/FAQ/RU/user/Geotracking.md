...
<html>
<meta charset="utf-8">
<meta name="keywords" content="история перемещений, геотрекинг, геотрэкинг, путевой лист, карта, перемещения сотрудника, сотрудники на карте, мобильные сотрудники, hubex, хабекс, хубекс, хабикс"/>
<ul>
...
<body>
<p><strong>История перемещений</strong> (геотректинг) отображает перемещения каждого сотрудника, у которого включена
