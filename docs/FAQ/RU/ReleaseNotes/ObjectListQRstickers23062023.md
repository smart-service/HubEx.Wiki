---
title: >-
  Список объектов в МП и QR-стикеры для маркировки в web-приложении: обновление
  от 23.06.2023
description: 'В мобильном приложении HubEx появился список объектов с историей обслуживания, а в веб-версии — заказ QR-стикеров для маркировки оборудования.'
keywords: 
...
<p>Подробнее читайте в статье нашей базы знаний: <a
        href="../user/CreatingTaskTemplates.html" target="_blank">Создание шаблона
...
<p>Предложения по доработкам в системе и сообщения об ошибках просим отправлять к нам в "чат с поддержкой" в
    веб-приложении или на почту <a href="mailto:help@hubex.ru" target="_blank" rel="noopener"> help@hubex.ru </a>.
</p>
