---
title: >-
  Фильтрация заявок по дополнительным полям с числовым форматом: обновление от
  01.12.2023
description: 'В HubEx можно фильтровать заявки по числовым дополнительным полям: точное значение, диапазон, больше или меньше.'
keywords: 
...
<p>Дополнительные поля создаются и настраиваются в консоли администратора. Подробнее об этом читайте в статье: <a href="../user/AdditionalFields.html" target="_blank">Создание дополнительных полей</a></p>
<div><img style="margin: 0 auto; display: block; max-width: 100%;" src="https://wiki.hubex.ru/attachments/images/FAQ/RELEASENOTES/FilterAddFields/Format.jpg" width="800" height="auto" /></div>
...
<div><img style="margin: 0 auto; display: block; max-width: 100%;" src="https://wiki.hubex.ru/attachments/images/FAQ/RELEASENOTES/FilterAddFields/Filter.jpg" width="800" height="auto" /></div>
<p>Задайте необходимы параметры и значения поиска для числовых полей и нажмите кнопку <strong>Применить</strong>.</p>
<div><img style="margin: 0 auto; display: block; max-width: 100%;" src="https://wiki.hubex.ru/attachments/images/FAQ/RELEASENOTES/FilterAddFields/Filter2.jpg" width="800" height="auto" /></div>
<p>Список <strong>Заявок</strong> будет отфильтрован согласно установленным параметрам поиска по дополнительным полям.</p>
<div><img style="margin: 0 auto; display: block; max-width: 100%;" src="https://wiki.hubex.ru/attachments/images/FAQ/RELEASENOTES/FilterAddFields/Result.jpg" width="800" height="auto" /></div>
