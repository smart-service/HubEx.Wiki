...
description: >-
  Добавили возможноность добавления дополнительных полей с типом Значение из
  справочника для Договоров и Компаний. Добавили возможность редактирования
  материалов без импорта
keywords: >-
  справочник, дополнительное, поле, материалы, склады, договор, компания, hubex,
