...
description: 'В HubEx к Объекту можно прикрепить план помещения и отмечать на нём расположение поломки при подаче заявки — в веб- и мобильном приложениях.'
...
<p>Если план помещения будет загружен для родительского объекта, то при выборе в <Strong>Заявке</Strong> дочерних объектов, если у
    ...
    подтягиваться план родителя. Подробнее о родительских и дочерних объектах можно прочитать в статье: <a
            href="./CreatingObjects.html">Создание обслуживаемого оборудования</a>.
</p>
...
<!--Если для настроек <Strong>Роли</Strong> включено
    ...
    <a
            href="./CreatingTaskTemplates.html#passport">Создание шаблона заявки,
        подача заявки по QR-коду</a>, <a
            href="../admin/Roles.html">Настройка ролей</a>.-->
...
___
### Следующие шаги:
- [График работы исполнителей](./Schedule.html)
