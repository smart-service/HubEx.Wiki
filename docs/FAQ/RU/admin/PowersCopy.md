---
title: 'Полномочия роли: детальный разбор блоков доступа'
description: 'Постатейный разбор полномочий ролей HubEx по блокам: что открывает каждая настройка — от заявок и объектов до интеграций, складов и шаблонов.'
