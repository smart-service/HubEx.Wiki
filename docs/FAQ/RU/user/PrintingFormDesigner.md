...
description: >-
  В приложении диспетчера можно создать свою кастомную печатную форму, которая
  автоматически будет добавлена в заявки, а переменные в печатной форме будут
  заменяться на значенияпараметров.
keywords: >-
  создать печатную форму, печатная форма, кастомная печатная форма, создать свой
  акт, акт выполненных работ, акт компании, печатная форма компании, hubex,
...
<img src="/attachments/images/FAQ/USER/PrintingFormDesigner/ComplitedWorks.png">
</li>
</ul>
</li>
</ul>
