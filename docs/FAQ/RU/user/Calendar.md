...
<ol>
    <li><strong>Расписание на день</strong>
        <p>Расписание на текущий день отображает занятость каждого <strong>Сотрудника</strong> на день с разбивкой по часам. </p>
    ...
    <li><strong>Расписание на неделю</strong>
        ...
        <p>График работы задается для каждого <strong>Сотрудника</strong> в его карточке на вкладке <strong>Трудоустройство</strong>. Подробнее читайте в
        ...
        <p>По щелчку на ячейку с загрузкой исполнителя будет доступна только вкладка <strong>Назначенные</strong>. Таким образом вы
            ...
            календаря фильтрация по назначенным <strong>Заявкам</strong> сбрасывается. </p>
        ...
        <p>Как назначить <strong>Заявку</strong> на исполнителя с помощью недельного календаря? Неназначенные <strong>Заявки</strong> также отображаются в
            ...
            нажатии на любую ячейку <strong>Без исполнителя</strong> все <strong>Заявки</strong> этой ячейки отобразятся в списке <strong>Неназначенные</strong>.
        </p>
        <div>
            <img style="margin: 0 auto; display: block; max-width: 95%;"
    ...
    <li><strong>Расписание на месяц</strong>
        ...
        <p>Чтобы посмотреть, какие <strong>Сотрудники</strong> работают в определенный день, щелкните по этому дню мышкой. Справа в
        ...
        <p><strong>Заявки</strong> без исполнителя отображаются справа на вкладке<strong> Неназначенные</strong>, а также в ячейках согласно установленному в
...
<div>
    <img style="margin: 0 auto; display: block; max-width: 85%;" src="/attachments/images/FAQ/USER/Calendar/Mob1.jpg"/>
</div>
...
<p>При назначении <strong>Заявок</strong> в <strong>Расписании заявок</strong> уведомления будут приходить с задержкой
    ...
    другого специалиста, то первому назначенному уведомление не придет. Если <strong>Заявка</strong> была снята спустя 5 минут, то инженеру придет новое
