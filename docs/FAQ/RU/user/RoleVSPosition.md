...
<p><strong>Роли</strong> создаются и настраиваются в <a href="../admin/HowToEnterTheAdmin.md">консоли
...
<p>Подробнее читайте в статьях: <a href="../admin/Roles.md">Настройка ролей</a>, <a
        href="../admin/ElementsOfInterface.md">Поля на форме заявки</a>.</p>
