...
description: >-
  Внести материалы и создать склады в HubEx можно в меню Склады - Материалы по
  кнопке Импорт материалов. Если вы загружаете материалы в первый раз, в
  появившемся окне выберите Скачать форму шаблона. После чего будет скачан
  специальный шаблон в формате Excel, который необходимо заполнить.
keywords: >-
  создать склад, загрузить материалы, оприходование материалов, инвентаризация,
  остатки, номенклатура, код номенклатуры, hubex, хабекс, хубекс, хабикс
category: user
---
...
<ul>
    ...
    <li><a href="#chapter2">Ручное создание складов;</a></li>
    <li><a href="#chapter3">Ручное создание материалов;</a></li>
...
<ul>
    <li>указывать рекомендуемые материалы в Заявке. Подробнее читайте в статье: <a href="./TicketWithMaterials.html">Подача заявки с указанием рекомендованных материалов</a>;</li>
    <li>указывать фактический расход материалов по Заявке. Подробнее читайте в статье: <a href="./Withdrawals.html">Расход материалов по заявке, отчет по расходу</a>;</li>
    <li>включать стоимость материалов в Акт выполненных работ. Подробнее читайте в статье: <a href="./ActOFAcceptance.html">Акт выполненных работ</a>;</li>
    <li>отслеживать остатки материалов. Подробнее читайте в статье: <a href="./Withdrawals.html">Расход материалов по заявке, отчет по расходу</a>.</li>
...
<div class="card">
<h5 id="chapter2">Ручное создание складов</h5>
<p>Помимо импорта через Excel, вы можете создать склад вручную прямо в web-интерфейсе:</p>
<ol>
    <li>Перейдите в меню <strong>Склады | Материалы</strong>.</li>
    <li>Нажмите кнопку <strong>Создать склад</strong> — откроется боковая панель.</li>
    <li>Заполните поля:</li>
</ol>
<ul class="field-list">
    <li><strong>Название склада</strong> — обязательное поле;</li>
    <li><strong>Адрес склада</strong> — необязательное поле для указания адреса размещения;</li>
    <li>
        <strong>Пользователи склада</strong> — радиобаттон с тремя значениями:
        <ul style="margin-top: 0.3rem; padding-left: 1.8rem;">
            <li><span class="radio-option"><em>Никто</em></span> — склад недоступен никому, кроме пользователей с полномочием доступа ко всем складам;</li>
            <li><span class="radio-option"><em>Все</em></span> — склад доступен всем сотрудникам тенанта;</li>
            <li><span class="radio-option"><em>По списку</em></span> — выбор конкретных сотрудников через модальное окно;</li>
        </ul>
    </li>
    <li><strong>ERP ID</strong> — числовое поле для синхронизации с внешней системой (необязательное);</li>
    <li><strong>Выбрать основным складом</strong> — чекбокс, помечающий склад как основной.</li>
</ul>
<div class="highlight-box">
    <strong>Важно!</strong>
    <span>При выборе режима «По списку» необходимо добавить хотя бы одного сотрудника. Настроить доступ пользователя к определённым складам по-прежнему можно в карточке Сотрудника на вкладке Квалификация.</span>
</div>
<hr>
</div>
<div class="card">
<h5 id="chapter3">Ручное создание материалов</h5>
<p>Справочник материалов также можно пополнять вручную, без подготовки Excel-шаблонов:</p>
<ol>
    <li>Перейдите в меню <strong>Склады | Материалы</strong> на вкладку <strong>Материалы</strong>.</li>
    <li>Нажмите кнопку <strong>Создать материал</strong> — откроется боковая панель.</li>
    <li>Заполните поля:</li>
</ol>
<ul class="field-list">
    <li><strong>Наименование</strong> — обязательное поле;</li>
    <li><strong>Описание</strong> — многострочное текстовое поле (необязательное);</li>
    <li><strong>Артикул</strong> — текстовое поле (необязательное);</li>
    <li>
        <strong>Единица измерения</strong> — выпадающий список, обязательное поле <span class="default-value">(по умолчанию — «Штука»)</span>;
    </li>
    <li><strong>Стоимость</strong> — дробное числовое поле (необязательное);</li>
    <li><strong>ERP ID</strong> — текстовое поле для связи с внешней системой (необязательное);</li>
    <li><strong>Маркируемый материал</strong> — чекбокс, признак маркируемого материала для Data Matrix («Честный знак»).</li>
</ul>
<p style="margin-top: 1.2rem;">Также в таблице материалов доступно <strong>контекстное меню</strong> (три точки):</p>
<ul class="context-menu">
    <li><strong>Копировать</strong> — открывает боковую панель создания со всеми заполненными полями оригинала. Название автоматически дополняется префиксом «Копия».</li>
    <li><strong>Удалить</strong> — удаляет материал после подтверждения.</li>
</ul>
<div class="highlight-box">
    <strong>Важно!</strong>
    <span>Функционал импорта материалов через Excel сохраняется и работает параллельно с ручным созданием. При копировании материала значение ERP ID также переносится — убедитесь, что оно не дублируется с существующими записями.</span>
</div>
<hr>
</div>
...
<p>Для того, чтобы <strong>Сотрудник</strong> при выполнении <strong>Заявки</strong> (заполнение вкладки <strong>Выполнение</strong> в <strong>Заявке</strong>) смог указать расход материалов, в
    ...
    карточке <strong>Сотрудника</strong> на вкладке <strong>Квалификация</strong> (блок <strong>Доступные склады</strong>). Подробнее читайте в статье: <a
            href="./CreatingUser.html">Создание пользователя вашей системы</a>.
</p>
