#### Создание паспорта объекта с возможность саморегистрации
...
Не забудьте нажать кнопку «Сохранить», чтобы сохранить введенную информацию. После нажатия на копку «Сохранить» страничка обновиться, и перед вами будет новый QR-код, который можно загрузить и распечатать (про то, как это сделать, читайте <a href="https://wiki.hubex.ru/docs/FAQ/RU/user/CreatingTaskTemplates.html#downloadqr"> здесь</a>), и, конечно же, подать заявку.
