...
description: 'В HubEx можно создавать недельные и сменные графики работы сотрудников — они учитываются при автоназначении исполнителей и отображении их занятости.'
keywords: >-
  график работы, графики работы, расписание, график сотрудника, hubex, хабекс,
  хубекс, хабикс
category: admin
---
...
<p id="schedule"><strong>График работы</strong> исполнителей позволяет учитывать рабочее время сотрудников при
    ...
    <a href="./RulesOfChoice.html">Правила автоназначения исполнителя</a>, <a
            href="../user/RulesOfChoiceGEO.html">Автоназначение на ближайшего
        исполнителя</a>.</p>
