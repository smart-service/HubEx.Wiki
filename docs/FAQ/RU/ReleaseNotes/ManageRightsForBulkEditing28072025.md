...
description: >-
  Мы добавили более гибкую систему управления правами для массовых операций с
  заявками и объектами
keywords: >-
  Массовое, Редактирование, Заявки, Объекты, объект, заявка, заявки, hubex,
