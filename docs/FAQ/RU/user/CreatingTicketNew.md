...
<ul>
    <li><b><a href="#task1">Что такое заявка в HubEx;</a></b></li>
    <li><b><a href="#task2">Основные поля на форме заявки;</a></b></li>
    <li><b><a href="#task3">Что представляет собой список заявок;</a></b></li>
    <li><b><a href="#task4">Вспомогательные поля на форме заявки;</a></b></li>
    <li><b><a href="#task5">Дополнительная информация о заявках;</a></b>
        <ul>
