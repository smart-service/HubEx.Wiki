...
description: Создать новую Заявкуможно в меню Заявки - Все заявки. В списке будут находиться все Заявки по вашей компании (или компаниям). Нажмите кнопку Создать заявку. Заявка на момент создания имеет только одну вкладку слева - Заявка. После сохранения
...
<html>
<meta charset="utf-8"> 
<meta name="keywords" content="создать заявку, подать заявку, заявка в мобильном приложении, hubex, хабекс, хубекс, хабикс"/>
...
<p><strong>Заявки</strong> в системе могут иметь иерархическую структуру: дочерние заявки подчиняются родительским. На
    вкладке <strong>Дочерние
        заявки</strong> можно создавать дочерние заявки и просматривать уже созданные. С помощью дочерних заявок можно
