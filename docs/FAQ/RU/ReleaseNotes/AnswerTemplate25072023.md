...
description: 'Как создавать и использовать шаблоны ответов в чатах HubEx, чтобы быстрее отвечать заказчикам и исполнителям.'
keywords: 
...
<p>Функционал <strong>Шаблоны ответов</strong> позволяет использовать предварительно написанные ответы в чатах с заказчиками и в чатах с исполнителями, тем самым оптимизировать процесс общения и поддержки.</p>
...
<li>поддержку и помощь собственным сотрудникам: шаблоны ответов можно использовать как базу знаний для ваших сотрудников, с помощью которой диспетчер сможет быстро и качественно ответить на вопросы исполнителей; </li>
...
<p>Подробнее читайте в статье базы знаний: <a href="../user/AnswerTemplate.html">Шаблоны ответов</a>.</p>
