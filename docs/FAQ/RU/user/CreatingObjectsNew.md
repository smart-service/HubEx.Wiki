...
<h3 id="object2">Основные поля (часть 1)</h3>
...
<h3 id="object4">Основные поля (часть 2)</h3>
...
<h3 id="object5">Раздел объекта "Контактные лица"</h3>
...
<h3 id="object6">Функционал "Мобильное оборудование"</h3>
...
<h3 id="object7">Функционал "Планы помещений"</h3>
...
<h3 id="object8">Раздел объекта "QR-коды" (функционал "Приемка и маркировка")</h3>
...
<h3 id="object9">Раздел объекта "Дополнительные поля"</h3>
...
<h3 id="object10">Раздел объекта "Дочерние объекты"</h3>
...
<h3 id="object11">Раздел объекта "История обслуживания"</h3>
...
<h3 id="object12">Для интеграций (дополнительно)</h3>
