...
description: 'В HubEx заявки автоматически архивируются через 190 дней после закрытия, а доступ к удалённым заявкам получает только администратор системы.'
keywords: 
...
<p>Подробнее читайте в статье базы знаний: <a href="../admin/Roles.html">Настройка ролей</a>.</p>
