...
<p>Обратите внимание, что на вкладках <strong>Выявление проблем в бизнес-процессах</strong> и <strong>Сравнение
    эфеективности процессов</strong> рассматриваются только закрытые <strong>Заявки</strong>. Для того, чтобы определить
    процесс, он должен быть завершен.</p>

<p>Выбранный период для отчета - это период, в который <strong>Заявки</strong> были выполнены. </p>
...
<p>В примере обратитме внимание на стадию <strong>Ожидает ТМЦ</strong> переход с которой занял 2 месяца. Возможно, нужных запчастей не
    оказалось на
...
<p>Для отчета также доступна стандартная фильтрация, которая настраивается по кнопке <strong>Открыть
    ...
    одному типа и т.д. Фильтры работают на всех вкладках отчета. </p>
