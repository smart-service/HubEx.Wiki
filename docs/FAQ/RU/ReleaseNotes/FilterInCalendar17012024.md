...
description: 'В календаре заявок HubEx можно фильтровать список сотрудников по видам работ, участкам, компаниям и ролям.'
keywords: 
...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/Calendar.html" target="_blank">Календарь заявок</a>.</p>
