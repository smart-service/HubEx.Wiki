...
<ol>
    ...
    <li>Календарь: блок предназначен для настройки доступа к пункту меню web-приложения Заявки - Расписание заявок.
        ...
        <p>Элементы интерфейса:</p>
        <ul>
            <li>Пункт главного меню - Расписание заявок: полномочие предоставляет доступ к пункту меню web-приложения Заявки - Расписание заявок.
            </li>
    ...
    <li>Классы объекта: блок предназначен для настройки доступа к пункту меню консоли администрирования Структура предприятия - Классы оборудования.
        <div>
            <img style="margin: 0 auto; display: block; max-width: 80%;"
        ...
        <ul>
            ...
            <li>Добавление классов объекта: при включении полномочия в меню консоли
                администрирования Структура предприятия - Классы оборудования появится кнопка Создать класс оборудования;
            </li>
            <li>Копирование классов объекта: при включении полномочия в меню Структура предприятия - Классы оборудования в
                контекстном меню (три точки) появится пункт Копировать;
            </li>
            ...
            <li>Изменение классов объекта: при включении полномочия откроется возможность вносить изменения в уже созданные классы объектов, на форме Класса оборудования появится кнопка Сохранить;
            </li>
    ...
    <li>Компании: блок предназначен для настройки доступа к пункту меню консоли администрирования Структура предприятия - Классы оборудования.
        <div>
            <img style="margin: 0 auto; display: block; max-width: 80%;"
        ...
        <ul>
            ...
            <li>Изменение компании: при включении полномочия откроется возможность вносить изменения в уже созданные карточки Компаний, на форме Компании появится кнопка Сохранить;
            </li>
            <div>
                <img style="margin: 0 auto; display: block; max-width: 80%;"
    ...
    <li>Критичности: блок предназначен для настройки доступа к пункту меню консоли администрирования Настройки заявки - Критичности.
        <div>
            <img style="margin: 0 auto; display: block; max-width: 80%;"
        ...
        <ul>
            ...
            <li>Сохранение критичностей заявок: при включении полномочия пользователю будет доступно редактрирование уже созданных Критичностей и их сохранение;
            </li>
    ...
    <li>Материалы и склады: блок предназначен для настройки доступа к работе с загрузкой материалов, просмотром расхода по материалам. Эти функции находятся в меню web-приложения Склады.
        <div>
            <img style="margin: 0 auto; display: block; max-width: 80%;"
