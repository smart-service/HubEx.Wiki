...
<ul>
    <li>Расчета заработной платы сотрудников;
        <p><strong>Раздел статьи:</strong> <a href="./Prices.md#Prices2">Ставка в час и стоимость видов работ</a></p>
    </li>
    <li>Расхода материалов и их стоимостей в заявке;
        <p><strong>Раздел статьи:</strong> <a href="./Prices.md#Prices3">Стоимость материалов</a></p>
    </li>
    <li>Фиксации выполнения услуг и финансовых обязательств заказчика перед исполнителем;
        <p><strong>Раздел статьи:</strong> <a href="./Prices.md#Prices4">Юридические и банковские реквизиты компании</a></p>
    </li>
    <li>Учета оценочной и фактической стоимости заявки.
        <p><strong>Раздел статьи:</strong> <a href="./Prices.md#Prices5">Оценочная и фактическая стоимость заявки</a></p>
    </li>
</ul>

<p>О том как взаимодействуют между собой каждая вышеупомянутая сущность описывается в разделе данной статьи <a href="./Prices.md#Prices6">Стоимости в выполненных работах по заявке</a> и <a href="./Prices.md#Prices7">Стоимости в акте выполненных работ по заявке</a>.</p>
...
<ul>
    ...
    <li>Введите в поле <strong>"Ставка в час"</strong> стоимость 1 часа сотрудника;
        <p><strong>1. Обратите внимание!</strong> Массово заполнить ставку в час для всех сотрудников вы можете только при создании сотрудников через импорт. Подробнее в статье: <a href="./Import.md#workers">Импорт сотрудников</a>.</p>
...
<p>О том как считается заработная плата сотрудников на основе ставки в час и выполненных работ мы рассказываем в разделе данной статьи <a href="./Prices.md#Prices8">Расчет заработной платы сотрудников</a>.</p>

<h2 id="Prices3">Стоимость материалов</h2>

<p>С помощью указания <strong>Стоимости материалов</strong> и дальнейшего списания этих материалов в заявке, их стоимость будет входить в <a href="./Prices.md#Prices7">Акт выполненных работ по заявке</a>.</p>
...
<p><strong>Стоимость материалов</strong> указывается при импорте складов и материалов в ваш бизнес-аккаунт HubEx. Подробнее об импорте материалов читайте в статье: <a href="./MaterialsNew.md#Materials3">Создание складов и материалов</a>.</p>

<p><strong>Обратите внимание!</strong> Вы можете изменить изначально указанную <strong>Стоимость материалов</strong> в бизнес-аккаунте HubEx с помощью изменения шаблона <strong>Экспорта материалов</strong> и его загрузки обратно. Подробнее в статье: <a href="./MaterialsNew.md#Materials8">Изменение количества материалов на складах</a>.</p>
...
<p>Реквизиты <strong>Вашей компании</strong> и <strong>Компании-заказчика</strong> будут отображаться в <a href="./Prices.md#Prices7">Акте выполненных работ</a>.</p>
...
<p>Видимость этих полей можно настроить через <a href="../admin/ElementsOfInterface.md">Поля на форме заявки</a>.</p>
...
<p>Подробнее о <strong>Выполненных работах</strong> вы можете почитать в статье: <a href="./AttachingFiles.md">Прикрепление выполненных работ в web и мобильном приложении</a>.</p>
...
<p>Подробнее об <strong>Акте выполненных работ</strong> вы можете почитать в статье: <a href="./ActOFAcceptance.md">Акт выполненных работ</a>.</p>
