---
title: Создание заявки (Устаревшая статья)
    ...
    <li><strong>Тип заявки</strong> - это классификация <strong>Заявок</strong> определяющая последовательность действий
        ...
        <p>Также для разных <strong>Типов заявки</strong> можно настроить автоматический расчет крайнего срока закрытия
            ...
            в статье: <a href="https://wiki.hubex.ru/docs/FAQ/RU/admin/SLA.html">SLA - правила расчета крайнего срока
                закрытия заявки</a>. </p>
                <p>Обратите внимание! После сохранения <strong>Заявки</strong> ее тип изменить будет нельзя! Чтобы заменить тип в уже созданной <strong>Заявке</strong> ее необходимо скопировать, а некорректную - удалить. Подробнее читайте в статье: <a href="https://wiki.hubex.ru/docs/FAQ/RU/user/ElectedTicket.html">Копирование и удаление заявок, заявки в избранном</a>.</p>
    </li>
...
<ol>
    <li><strong>По релевантности</strong>: этот вариант сортирует список сотрудников учитывая следующие параметры:
        ...
        <p> <div>
        <img style="margin: 0 auto; display: block; max-width: 80%;"
             src="/attachments/images/FAQ/USER/CreatingTicket/Relevance.jpg"/>
    </div>
    </p>
    <p>При наведении на иконки будет всплывать подсказка с расшифровкой. На картинке ниже представлена расшифровка всех возможных криетериев отбора.</p>
     <p> <div>
        <img style="margin: 0 auto; display: block; max-width: 50%;"
             src="/attachments/images/FAQ/USER/CreatingTicket/Icons.jpg"/>
    </div>
    </p>
    </li>
    <li><strong>ФИО исполнителя</strong>: этот вариант сортирует список по алфавиту от А до Я.
     <p> <div>
        <img style="margin: 0 auto; display: block; max-width: 80%;"
             src="/attachments/images/FAQ/USER/CreatingTicket/FIO.jpg"/>
    </div>
    </p>
    </li>
...
<p>Каждый из выбранных специалистов получит уведомление о назначении на <strong>Заявку</strong>, сможет добавлять выполненные работы и переводить <strong>Заявку</strong> на стадии в мобильном приложении <strong>HubEx исполнитель</strong>.</p>
    ...
    <li id="deadlinetick"><strong>Крайний срок закрытия</strong> - это максимально возможная дата и время закрытия
        ...
        <p>Важный критерий качества предоставляемых услуг - соблюдение
            сроков выполнения <strong>Заявок</strong>. Временные нормы могут быть прописаны в договорах (контрактах) с вашими
            заказчиками и отличаться
    ...
    <li><strong>Наша компания</strong> устанавливается вручную из списка <strong>Компаний</strong> с видом
        <strong>Наша компания</strong>. Если у вас несколько собственных организаций, вручную выберите одну из
...
<li><strong>Правило расчета крайнего срока закрытия</strong>: данное поле заполняется автоматически после сохранения <strong>Заявки</strong>. Здесь отображается правило, по которому рассчитался срок выполнения заявки и заполнилось поле <strong>Крайний срок закрытия</strong>. Подробнее читайте в статье: <a
    ...
    <li><strong>Инициатор заявки</strong> устанавливается автоматически, если <strong>Заявка</strong> создается
        ...
        web- или мобильное приложение, при необходимости инициатора можно изменить. Подробнее читайте в статье: <a href="https://wiki.hubex.ru/docs/FAQ/RU/user/UsersRequests.html">Инициатор заявки: создание инициатора, история обращений</a>.
    </li>
