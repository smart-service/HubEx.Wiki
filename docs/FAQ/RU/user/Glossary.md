...
keywords: >-
  термины, определения, заказчик, исполнитель, заявка, объект, hubex, хабекс,
  хубекс, хабикс
category: user
---
...
<table style="border-collapse: collapse; width: 100%; height: 180px;" border="1">
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>Подробнее читайте в статьях: <a href="../admin/RulesOfChoice.html">Правила
                автоназначения исполнителя</a>, <a href="./RulesOfChoiceGEO.html">Автоназначение
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>Подробнее читайте в статье: <a href="./RulesOfChoiceGEO.html">Автоназначение
                на ближайшего исполнителя</a>.</p>
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>Подробнее читайте в статьях: <a href="../admin/BusinessProcess.html">Базовый
                бизнес-процесс для заявки</a>, <a
                    href="../admin/TicketType.html">Типы заявок</a>,
                <a href="../admin/StageType.html">Стадии заявки</a>, <a
                        href="../admin/TicketLifeCycle.html">Жизненный
                    цикл заявки</a>.</p>
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>С помощью настройки прав доступа для заказчика ограничивается доступ к функционалу системы. Например,
                ...
                т.д.</p>
            <p>Подробнее читайте в статьях: <a href="./CreatingCustomer.html">Создание
                заказчика</a>.</p>
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>Исполнители, как и другие сотрудники вашей организации создаются в справочнике <strong>Пользователи –
                Сотрудники</strong>.</p>
            <p>Подробнее читайте в статье: <a href="./CreatingUser.html">Создание
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>Подробнее читайте в статье: <a href="./CreatingCompany.html">Создание
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>Подробнее читайте в статье: <a href="../admin/RulesOfChoice.html">Правила
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>Подробнее читайте в статье: <a href="../admin/SLA.html">SLA - правила
...
<p>Благодаря такой классификации можно формировать аналитические отчеты в разрезе <strong>Типов оборудования</strong> (<a
        href="./ObjectsAnalytics.html">Отчет
    по объектам</a>, <a href="./ClientsAnalytics.html">Отчет для клиента</a>).</p>
...
<p>При создании <strong>Типов оборудования</strong> обратите внимание на флажок <strong>Обязательное наличие
    ...
    этих <strong>Заявок</strong>, подбора ближайших исполнителей к месту нахождения <strong>Объекта</strong> из <strong>Заявки</strong>.
            ...
            <p>Подробнее читайте в статьях: <a href="./CreatingObjects.html">Создание
                обслуживаемого оборудования</a>, <a href="../admin/ObjectsType.html">Типы оборудования</a>.</p>
        </td>
    </tr>
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>Подробнее читайте в статье: <a href="../admin/Places.html">Настройка
                участков</a>.</p>
    ...
    <tr style="height: 18px;">
        ...
        <td style="width: 50%; height: 18px;">
            ...
            <p>Подробнее читайте в статье: <a
                    href="./Checklists.html">Чек-листы</a>.
            </p>
        </td>
    </tr>
