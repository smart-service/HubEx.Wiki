...
<p dir="auto">Следите за обновлениями в разделе <a href="../docs/FAQ/RU/ReleaseNotes/" target="_blank" rel="nofollow">Новости системы</a>.</p>
...
<li class="text-start "><a href="../docs/FAQ/RU/user/Materials.html" target="_blank" rel="nofollow">Загрузка материалов и создание складов</a></li>

<li class="text-start "><a href="../docs/FAQ/RU/user/Withdrawals.html" target="_blank" rel="nofollow">Расход материалов по заявке, отчет по расходу</a></li>

<li class="text-start "><a href="../docs/FAQ/RU/user/InventoryAccounting.html" target="_blank" rel="nofollow">Складской учет в HubEx: два сценария управления складом</a></li>

<li class="text-start "><a href="../docs/FAQ/RU/user/SettingsWithMaterials.html" target="_blank" rel="nofollow">Настройки системы для работы с материалами</a></li>
