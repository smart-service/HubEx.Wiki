...
В мобильном приложении сотруднику, при переходе к сообщениям заявки, доступны оба чата и между ними можно переключаться.

<div>
  <img  style="margin: 0 auto; display: block; max-width: 100%;" src="/attachments/images/FAQ/USER/Messages/mes8.jpg" />
</div>

У сотрудников в веб-версии HubEx есть возможность отправлять сообщения в оба чата, для этого нужно написать сообщение и активировать чек-бокс «Также отправить сообщение команде» или «Также отправить сообщение заказчику».
