...
<p>Подробнее читайте в статьях базы знаний: <a href="../user/Materials.md">Загрузка материалов и создание складов</a>, <a href="../user/Withdrawals.md">Расход материалов по заявке, отчет по расходу</a>.</p>
