...
<body>
<h2>Обновление&nbsp;<span data-teams="true">Автоматическая привязка видов работ к типам оборудования,&nbsp;Новые виджеты в Панели управления администратора от 02.09.2025</span></h2>
<hr />
<h2><span data-teams="true">🚀 Автоматическая привязка видов работ к типам оборудования</span></h2>
<h2>📆 Дата релиза: 09.09.2025</h2>
<h2>🌟 Что нового?</h2>
...
<h3>📋 Централизованное управление видами работ</h3>
<ul>
...
<li>📞 <strong>Контакты</strong> - необходимая информация для связи клиента с HubEx</li>
<li><strong>💰 Оплата</strong> - ссылки для покупки лицензий, продления и т.п.</li>
</ul>
<h3>⚙️ Как начать использовать?</h3>
<ol>
<li>Добавляем плагин в систему, с ResourcesID: 29</li>
