...
<body>
<p>Шаблон объектов (оборудования) – образец карточки объекта (оборудования) с заполненными полями: <strong>Родительский
    объект</strong>,
...
<p id="2">Приемка по QR-коду возможна в двух вариантах:</p>
<ol>
    ...
    <li>вы сначала создаете QR-код в web-приложении без привязки к конкретному оборудованию, распечатываете его и
        ...
        оборудование, затем маркируете. Как создать свой QR-код читайте в статье: <a
                href="https://wiki.hubex.ru/docs/FAQ/RU/user/CreatingTaskTemplates.html">Создание шаблона для подачи
            заявки по QR-коду</a>.
    </li>
</ol>
...
<p id="3">Маркировка по QR-коду работает с уже существующим на объекте QR-кодом, который не использовался ранее в
    HubEx:</p>
<ol>
    <li>Откройте в мобильном приложении инженера меню <strong>Приемка и маркировка</strong>.</li>
   <p> <div>
...
<p>Обратите внимание! Привязывая QR-код к <strong>Объекту</strong>, или создавая новый <strong>Объект</strong> по QR-коду, в HubEx автоматически будет
    ...
    найти в меню <strong>Заявки - Маркировка</strong>. Подробнее читайте в статье: <a
            href="https://wiki.hubex.ru/docs/FAQ/RU/user/CreatingTaskTemplates.html">Создание шаблона для подачи
        заявки по QR-коду</a>. В дальнейшем вы сможете подавать <strong>Заявки</strong> по такому QR-коду в мобильном приложении
    инженера.</p>
