...
<p dir="auto">Чтобы система контролировала обязательное сканирование перед закрытием заявки, настройте права доступа к полю &laquo;Выполненные работы&raquo;:</p>
<ol dir="auto" start="1">
...
<li class="text-start">В открывшейся таблице найдите поле <strong>&laquo;Выполненные работы&raquo;</strong>.</li>
...
<p dir="auto"><strong>Как это работает:</strong> при попытке перевести заявку на статус с требованием RWM для поля &laquo;Выполненные работы&raquo; система проверит, что для каждого маркируемого материала количество отсканированных кодов равно списанному количеству. Если условие не выполнено &mdash; смена статуса блокируется, и исполнитель видит сообщение об ошибке.</p>
...
<ol dir="auto" start="1">
<li class="text-start">Откройте заявку в мобильном приложении HubEx и перейдите в раздел <strong>&laquo;Выполненные работы&raquo;</strong>.</li>
...
<p dir="auto">После того как исполнитель отсканировал коды Data Matrix в мобильном приложении, диспетчер или руководитель может проконтролировать результат в веб-версии HubEx. Для этого необходимо открыть карточку нужной заявки и перейти в раздел <strong>&laquo;Выполненные работы&raquo;</strong>.</p>
<div >&nbsp;</div>
...
<li class="text-start ">Если на Шаге 3 настроен контроль обязательности сканирования (RWM для поля &laquo;Выполненные работы&raquo;), диспетчер сразу увидит: все ли коды отсканированы или каких-то не хватает. Пока все обязательные коды не будут привязаны, исполнитель не сможет перевести заявку на контролируемую стадию.</li>
