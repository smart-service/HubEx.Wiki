...
description: >-
  Классы оборудования - совокупность объектов (оборудования) с общими
  характеристиками, отличительными особенностями. Классы оборудования
  используются для группировки объектов и для группировки Заявок по объектам.
  Создать новые Классы оборудования можно в консоли администратора в меню
  Структура предприятия - Классы оборудования по кнопке Создать класс
  оборудования.
keywords: >-
  класс оборудования, класс объекта, классы оборудования, классы объектов,
...
<p>Создать новые <Strong>Классы оборудования</Strong> можно в консоли администратора в меню <Strong>Структура
    ...
    консоль подробно описано в статье <a
            href="./HowToEnterTheAdmin.html">Вход в консоль администратора</a>.
</p>
