...
<ul>
    ...
    <li><a href="#optionalfields">Какие поля Заявки необязательны для заполнения;</a></li>
    ...
    <li>В поле <strong>Исполнитель</strong> можно сразу указать специалиста, либо оставить это поле
        ...
        <ol>
            ...
            <li>с помощью настройки автораспределения заявок: в таком случае настраивается специальное <strong>Правило
                ...
                на стадию
                <strong>Назначена</strong> и в ее настройках указать правило автоназначения. Подробнее читайте в
                статьях: <a
...
<p>Подавать <strong>Заявку</strong> можно без привязки к <strong>Заказчику</strong> или <strong>Объекту</strong>, без
...
<p>На форме <strong>Заявки</strong> обязательными для заполнения полями являются только <strong>Тип заявки</strong> и
    <strong>Критичность</strong>. Отключить заполнение этих полей нельзя. Видимость и заполнение всех
...
<p>Итоговая <strong>Заявка</strong> с отключением всех полей может выглядеть следующим образом:</p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 70%;"
