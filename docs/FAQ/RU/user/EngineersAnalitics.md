...
<ol>
    <li><a href="#first">вкладка <Strong>Заявки и SLA</Strong>, где SLA - показатель качества
        предоставляемых услуг, основывающийся соблюдении времени исполнения (закрытия) <Strong>Заявки</Strong>,
        установленного по договору с заказчиком;
    </li>
    <li><a href="#second">вкладка <Strong>Отработанное время</Strong>;</li>
    <li><a href="#third">вкладка <Strong>Показатели и KPI</Strong>.</li>
</ol>
...
<p>Детализацию можно посмотреть с помощью кнопки <strong>Открыть аналитические разрезы</strong> на боковой панели.
    ...
    углубляться в данные для детального анализа. В примере нужно понять, какие <strong>Заявки</strong> специлист
...
<p>С помощью кнопки <strong>Включить аналитические разрезы</strong> на боковой панели вы можете открыть дополнительный
    отчет <strong>Аналитические разрезы</strong>, который позволяетт детализировать данные. Например, рассмотрим таблицу
