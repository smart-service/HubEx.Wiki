...
<ol>
    ...
    <li>Участки: блок предназначен для настройки доступа к пункту меню консоли администрирования Структура предприятия -
        ...
        <ul>
            ...
            <li>Сохранение участков: при включении полномочия на форме создания/редактирования участка появится кнопка Сохранить, также пользователь сможет редактировать уже созданные Участки;
            </li>
            ...
            <li>Удаление участков: при включении полномочия в меню Структура предприятия -
                Участки в контекстном меню (три точки) появится пункт Удалить;</li>
        ...
        <p>Справочники:</p>
        <ul>
            <li>Все участки: пользователю будут доступны все созданные Участки для выбора при создании Сотрудников, Заказчиков, Типов заявок, Объектов.
            </li>
    ...
    <li>Чек-листы: блок предназначен для настройки доступа к пункту web-приложения Чек-листы.
        ...
        <ul>
            ...
            <li>Изменение чек-листов: при включении полномочия на форме создания/редактирования участка появится кнопка Сохранить, также пользователь сможет редактировать уже созданные Чек-листы;
            </li>
    ...
    <li>Шаблоны объектов: блок предназначен для настройки доступа к пункту web-приложения Объекты|Оборудование - Шаблон объектов и оборудования.
        <div>
            <img style="margin: 0 auto; display: block; max-width: 80%;"
        ...
        <ul>
            ...
            <li>Создание шаблона объекта: при включении полномочия в меню Чек-листы появится кнопка Создать чек-лист;
            </li>

            <li>Удаление шаблона объекта: при включении полномочия в меню Структура предприятия -
                Участки в контекстном меню (три точки) появится пункт Удалить;</li>

            <li>Копирование шаблона объекта: при включении полномочия в меню Структура предприятия -
                Участки в контекстном меню (три точки) появится пункт Копировать;
            </li>
            <div>
                <img style="margin: 0 auto; display: block; max-width: 80%;"
            ...
            <li>Изменение шаблона объекта: при включении полномочия на форме создания/редактирования участка появится кнопка Сохранить, также пользователь сможет редактировать уже созданные Чек-листы;
            </li>
