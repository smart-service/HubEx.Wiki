...
<ol>
    ...
    <li><p>Чтобы распределить неназначенную <strong>Заявку</strong>, необходимо правой кнопкой
        ...
        <p><strong>Заявка</strong> назначается на исполнителя на текущее ближайшее время.
            ...
            Плановые трудозатраты могут быть установлены в Виде работ или в Типе заявки. Подробнее читайте в статьях: <a
...
<p>Дополнительно ознакомьтесь с видеороликом <strong>Распределение заявок в Hubex с помощью календаря и карты</strong>.
</p>
