...
<p>Вы можете оценить, как будет выглядеть ваш подготовленный логотип. Перейдите по <a href="https://disk.yandex.ru/d/cXhAxSjZjGoaCA" target="_blank">ссылке</a> и скачайте шаблоны HubEx, в любом редакторе изображений вместо выделенных красным областей подставьте свой логотип и оцените, как он будет смотреться. Если результат вас устраивает и логотип не нужно переделывать, то напишите нам в службу поддержки на почту <a
