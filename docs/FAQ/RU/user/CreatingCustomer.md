...
<p>Заказчик - пользователь, который может создавать заявки в мобильном приложении заказчика. Заказчик привязывается к
    компании-заказчику.
    С помощью настройки прав доступа для заказчика ограничивается доступ к функционалу системы. Например, заказчик
    сможет видеть только свои объекты (оборудование), видеть заявки только по своей компании и т.д.
</p>
