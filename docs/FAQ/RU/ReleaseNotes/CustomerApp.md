...
description: 'История обновлений мобильного приложения HubEx для заказчика: что нового появлялось в каждой версии выпуска.'
keywords: 
...
<p>Добавлена возможность просмотра местоположения мобильного исполнителя. Улучшена работа с локациями. </p>
...
<p>Подробнее читайте в статьях базы знаний: <a href="../user/SelfRegister.html">Подача заявок по QR-коду без приложения, самостоятельная регистрация нового пользователя</a>.</p>
