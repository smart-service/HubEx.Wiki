...
<p class="ds-markdown-paragraph">✅&nbsp;<strong>Автоматическая синхронизация заявок</strong>&nbsp;&ndash; создание заявок в HubEx на основа сделок в Битрикс24<br />✅&nbsp;<strong>Обмен компаниями из Битрикс24 в HubEx</strong>&nbsp;&ndash; актуальные данные клиентов в обеих системах<br />
