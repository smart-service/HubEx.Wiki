...
<p>После настройки интеграции в HubEx необходимо <a href="./Materials.md#matimp">загрузить
...
<div class="note-card">
        ...
        <div class="note-text">
            ...
            <a href="./Materials.md" target="_blank" rel="noopener noreferrer">
...
<p>Списание материалов в HubEx происходит во время заполнения выполненных работ в Заявке. В выполненных работах
    <a href="./Withdrawals.md">указываются израсходованные ТМЦ</a>.</p>
...
<p>В течение нескольких дней вам необходимо будет провести инвентаризацию своих запасов. Затем сформированный список
    ...
    Подробнее читайте в статье: <a href="./Materials.md">Загрузка материалов и
...
<p>При поступлении новых ТМЦ или при следующей процедуре инвентаризации вы сможете свести остатки и загрузить новую
    ...
    статье: <a
            href="./Materials.md#count">Загрузка материалов и создание складов:
...
<ul>
    <li>проверять <a href="./Materials.md#wima">наличие необходимых
        материалов</a> на складе из мобильного приложения <strong>HubEx иполнитель</strong>;
    </li>
    <li>вносить <a href="./Withdrawals.md">расход использованных материалов</a>
