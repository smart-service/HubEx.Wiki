...
description: >-
  ...
  пользователе, создавшем Заявку в HubEx. По факту не всегда Инициатором заявки
  является пользователь, который ее создает, например, Заявка может поступать по
  звонку от клиента, а создавать в HubEx Заявку будет диспетчер. Тогда диспетчер
  будет являться инициатором.
keywords: >-
  инициатор, инициатор заявки, история обращений, история заявок, hubex, хабекс,
  хубекс, хабикс
category: user
---
...
<p>По умолчанию все новые <strong>Инициаторы заявки</strong> будут создаваться как элементы справочника <strong>Заказчики</strong>. При необходимости вы
    потом можете перевести <strong>Заказчика</strong> в <strong>Сотрудники</strong>. Подробнее об этом читайте в статье: <a
            href="./CreatingUser.html#movetocust">Создание пользователя
