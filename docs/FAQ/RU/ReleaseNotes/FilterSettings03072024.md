...
description: 'Панель фильтров в списке заявок теперь можно настраивать под себя: добавлять, убирать и перетаскиванием менять порядок полей.'
keywords: 
...
<p>Дополнительно о работе с фильтрами для&nbsp;<strong>Заявок</strong>&nbsp;читайте в статье нашей базы знаний:&nbsp;<a href="../user/Filters.html" target="_blank" rel="noopener">Список заявок, поиск заявок с помощью фильтров</a>.</p>
<p>Информацию по созданию и настройке Дополнительных полей читайте в статье: <a href="../user/AdditionalFields.html">Создание дополнительных полей для заявки.</a><br /><br
