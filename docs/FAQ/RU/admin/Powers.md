...
<ol>
    ...
    <li>Навыки: БЛОК НЕ РАБОТАЕТ !!! БЛОК НАЧИНАЕТ ОТОБРАЖАТЬСЯ И РАБОТАТЬ КОГДА ВКЛЮЧЕНО ПОЛНОМОЧИЕ РОЛИ - ЭЛЕМЕНТЫ ИНТЕРФЕЙСА - ПУНКТ МЕНЮ РОЛИ
    ...
    <li>Роли: блок предназначен для настройки доступа к пункту меню консоли
        ...
        <ul>
            <li>Создание ролей: при включении полномочия в меню Администрирование - Роли появится кнопка Добавить роль.
                Чтобы создать новую Роль и сохранить ее необходимо также включить полномочие Роли - Элементы интерфейса - Изменение ролей;
            </li>
    ...
    <li>API полномочия: данный блок предназначен для настройки доступа к различным
        ...
        <Strong>Объекты - Создание объекта</Strong>, необходимо также включить настройку <Strong>API полномочия -
            Метод создания нового объекта</Strong>. Методов API в настройках большое количество, поэтому мы рекомендуем включать этот блок
        полностью для
        всех ролей. </li>
    ...
    <li>Сообщения: блок предназначен для настройки доступа к пункту меню Сообщения, а так же настройке доступа к переписке по Заявкам для web- и мобильного приложения.
        <div>
            <img style="margin: 0 auto; display: block; max-width: 80%;"
        ...
        <p>Элементы интерфейса:</p>
        <ul>
            <li>Отправка сообщения по заявке: при включении полномочия в меню Администрирование - Роли появится кнопка Добавить роль.
                Чтобы создать новую Роль и сохранить ее необходимо также включить полномочие Роли - Элементы интерфейса - Изменение ролей;
            </li>
            <li>Кнопка отправки внутреннего сообщения по заявке:
            </li>
            ...
            <li>Просмотр списка участников в сообщениях </li>

            <li>Чат с заказчиками
            </li>

            <li>Чат с сотрудниками
            </li>
        ...
        <p>Справочники:</p>
        <ul>
            <li>Сообщения с заказчиками по заявке
            </li>
            <li>Операции над всеми сообщениями по доступным заявкам
            </li>
            <li>Сообщения по всем доступным заявкам
            </li>
