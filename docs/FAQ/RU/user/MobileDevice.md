...
description: Работать в HubEx можно с помощью мобильных приложений. Для этого мобильный телефон должен соответствовать следующим требованиям Аккумулятор емкостью от 5 000 мА·ч; Версия операционной системы (Android, версии от 12.0 и старше, iOS, версии от 16.0 и старше); Диагональ экрана от 6,5 дюймов; Поддержка 4G связи; Камера от 8 МП.
...
<ol>
    ...
    <li>Камера от 8 МП;</li>
    <li>Модуль чтения NFC (при использовании NFC-меток в процессах).</li>
    <li>Список рекомендованных моделей: iPhone 14, iPhone SE (3-го поколения), iPhone 15, iPhone 16e.</li>
</ol>
