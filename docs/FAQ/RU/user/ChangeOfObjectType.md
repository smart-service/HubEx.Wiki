...
description: >-
  ...
  неактивным, заблокированным для редактирования. Чтобы изменить Тип
  оборудования карточке Объекта, нажмите кнопку Снять с публикации. Затем
  измените Тип оборудования. После внесения изменений обязательно сохраните
  карточку Объекта и нажмите кнопку  Опубликовать.
