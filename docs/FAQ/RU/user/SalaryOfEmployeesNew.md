...
<ul>
    ...
    <li><a href="#SalaryOfEmployees2">Ставка в час для сотрудника</a>;</li>
    <li><a href="#SalaryOfEmployees3">Стоимость видов работ</a>;</li>
    <li><a href="#SalaryOfEmployees4">Поля на форме заявки</a>;</li>
    <li><a href="#SalaryOfEmployees5">Выполненные работы по заявке</a>;</li>
    <li><a href="#SalaryOfEmployees6">Юридические и банковские реквизиты компании</a>;</li>
...
<ul>
    <li></li>
    <li>Расчета заработной платы сотрудников</li>
</ul>
...
<ol>
    ...
    <li>в каждую <strong>Заявку</strong> вносить выполненные работы на вкладку <strong>Выполнение</strong> (в web или
        ...
        работ можно изменять вручную. При этом ставка не изменится в карточке <strong>Сотрудника</strong> и в карточке
        <strong>Вида работ</strong>. Также
        ...
        <p>Обратите внимание! Поля <strong>Начало выполнения</strong> и <strong>Время</strong> заполняются
            автоматически датой и временем перехода на стадию Заявки, на которой происходит добавление выполненной
            работы. Поля <strong>Окончание выполнения</strong> и <strong>Время</strong> заполняются
            автоматически датой и временем добавления самой выполненной работы. Даты и время можно редактировать вручную.</p>
    </li>
    <p>
    <div>
        <img style="margin: 0 auto; display: block; max-width: 100%;"
...
<p>Обратите внимание! Ставка исполнителя, количество часов работы исполнителя и стоимость вида работ используются для
    ...
    выполненных работ для ваших заказчиков.</p>
<p>При расчете итоговой стоимости акта ставка исполнителя кратна одному часу: если ставка указана 500 рублей, а работа
    выполнялась 1 час
    35 минут, то итоговая стоимость будет равно 1000 рублей (500 * 2 часа), а не 790 рублей. Подробнее читайте в статье:
    <a
...
<ol>
    ...
    <li>откройте выгруженный файл формата .xlsx (таблицы Excel), перейти во вкладку <strong>Выполненные работы</strong>
        ...
        <p>Обратите внимание! Если по одной <strong>Заявке</strong> работало несколько исполнителей, то данные по
            выполнению для других
    ...
    <li>в таблицу выгружаются ставки сотрудников, стоимость по видам работ и количество отработанных сотрудником часов.
        ...
        <p>Рассмотрим на примере: при сдельной оплате труда зарплата начисляется в размере 40% от суммы всех
            видов работ,
            которые выполнил сотрудник. При таком варианте расчета необходимо с помощью формулы Excel <strong>=СУММ(число
                1, число 2, ...)</strong> сложить все суммы в колонке <strong>Стоимость вида
