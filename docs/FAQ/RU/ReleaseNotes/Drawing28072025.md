...
<li data-start="1654" data-end="1869">Далее необходимо настроить видимость и доступ к новому дополнительному полю - подробную инструкцию по добавлению доступа можно найти в статье <a href="../user/AdditionalFields.md">"Создание дополнительных полей"</a>.</li>
</ol>
