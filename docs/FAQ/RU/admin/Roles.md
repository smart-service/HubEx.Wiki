...
<p>Для создания и настройки <Strong>Роли</Strong> перейдите в <a href="https://wiki.hubex.ru/docs/FAQ/RU/admin/HowToEnterTheAdmin.html">консоль
    ...
    Роли</Strong>. В справочнике вы увидите уже созданные <Strong>Роли</Strong> в виде отдельных плиток с описанием. Нажамите кнопку <Strong>Добавить роль</Strong>. При создании новой <Strong>Роли</Strong> вы можете взять за основу уже существующую и скопировать ее
