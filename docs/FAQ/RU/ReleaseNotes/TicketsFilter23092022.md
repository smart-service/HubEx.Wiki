...
<body>
<p>Дополнительные поля расширяют возможности работы с <strong>Заявками</strong>: в них можно указывать площадь объектов, вносить заключение по итогу работы, указывать дату диагностикии т.д. Подробнее читайте в статье нашей базы знаний: <a href="../user/FloorPlan.md" target="_blank">Создание дополнительных полей для заявки</a>.</p>
