---
title: >-
  Полезные обновления (релевантность, паспорт объекта, экспорт): обновление от
  28.08.2023
description: 'Три улучшения HubEx: иконки критериев релевантности при выборе исполнителя, кликабельные ссылки в паспорте объекта и запоминание настроек экспорта.'
keywords: 
...
<div><img style="margin: 0 auto; display: block; max-width: 100%;" src="/attachments/images/FAQ/RELEASENOTES/ReleasePack28082023/1.png" width="900" height="auto" /></div>
...
<div><img style="margin: 0 auto; display: block; max-width: 100%;" src="/attachments/images/FAQ/RELEASENOTES/ReleasePack28082023/2.png" width="auto" height="260" /></div>

<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/CreatingTicket.html" target="_blank">Создание заявки</a>.</p>
...
<div><img style="margin: 0 auto; display: block; max-width: 100%;" src="/attachments/images/FAQ/RELEASENOTES/ReleasePack28082023/3.png" width="auto" height="660" /></div>
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/CreatingTaskTemplates.html#passportl" target="_blank">Создание шаблона заявки, подача заявки по QR-коду: паспорт объекта</a>.</p>
...
<div><img style="margin: 0 auto; display: block; max-width: 100%;" src="/attachments/images/FAQ/RELEASENOTES/ReleasePack28082023/4.png" width="900" height="auto" /></div>
<p>Обратите внимание! Настройки фиксируются для каждого браузера и компьютера индивидуально.</p>
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/Export.html" target="_blank">Экспорт</a>.</p>
