...
А для того чтобы выгрузить всю информацию по компаниям из системы HubEx, воспользуйтесь функцией "Экспорт". Подробнее про эту функцию читайте <a href="https://wiki.hubex.ru/docs/FAQ/RU/user/Export.html#companies"> здесь</a></p>.
