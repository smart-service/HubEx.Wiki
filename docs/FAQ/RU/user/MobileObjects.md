...
<p>Посмотреть историю перемещений такого оборудования вы можете с помощью экспорта <strong>Заявок</strong> с отбором по этому оборудованию. Подробнее читайте в статье: <a href="./Export.md">Экспорт</a>.</p>
