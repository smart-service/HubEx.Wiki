...
<p>Создать новый атрибут можно в <a href="../admin/HowToEnterTheAdmin.md">консоли администратора</a> в разделе левого бокового меню <strong>"Настройки системы"</strong> - подраздел <strong>"Дополнительные поля"</strong>.</p>
