...
description: 'Обзор отчета «Общая аналитика» в HubEx: ключевые показатели, графики по заявкам и фильтры для анализа бизнеса.'
keywords: 
...
<p>Подробнее об отчете читайте в статье базы знаний: <a href="../user/GeneralAnalytics.html">Общая аналитика</a>.</p>
