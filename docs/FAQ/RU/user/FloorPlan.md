...
<p>Чтобы изменить расположение метки нажмите на план, на экране появятся две кнопки:</p>
<ul>
    <li>зеленая галочка: оставить прежнюю метку, не менять расположение;</li>
...
<p>Для мобильного приложения работают теже принципы выбора планов помещенйи родительских объектов, что и для web-приложения.</p>
<p>Если план помещения будет загружен для родительского объекта, то при подаче <Strong>Заявки</Strong> на дочерний объекто, если у
