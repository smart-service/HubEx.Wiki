...
<p class="ds-markdown-paragraph"><strong>Поддерживаемые форматы:</strong><br /><code>JPEG</code>,&nbsp;<code>GIF</code>,&nbsp;<code>BMP</code>,&nbsp;<code>PNG</code>,&nbsp;<code>JFIF</code>,&nbsp;<code>HEIC</code></p>
...
<li>
<p class="ds-markdown-paragraph">Вставьте его в поле (<code>Ctrl+V</code>&nbsp;/&nbsp;<code>Cmd+V</code>).</p>
</li>
<li>
...
<ul>
<li>
<p class="ds-markdown-paragraph">Функционал доступен только для поля&nbsp;<strong>&laquo;Описание заявки&raquo;</strong>.</p>
</li>
<li>
<p class="ds-markdown-paragraph">Вставка изображений через перетаскивание (<code>drag &amp; drop</code>) на данном этапе не поддерживается.</p>
</li>
</ul>
...
<hr>
<h3><strong>🔗 Кастомная переадресация QR-кодов на домен клиента</strong></h3>
...
<hr>
<p class="ds-markdown-paragraph"><strong>📱 Сканирование Data Matrix в МП &mdash; Этап 2: Контроль списания маркируемых материалов</strong></p>
...
<h3>🎯&nbsp;<strong>Что нового?</strong></h3>
...
<h3>🚀&nbsp;<strong>Преимущества для бизнеса</strong></h3>
<ul>
<li>
