...
description: >-
  Добавили возможность смены Склада в поле "Израсходованные материалы" в
  выполненной работе вЗаявке.
keywords: >-
  материалы, склады, израсходованные материалы, ВР, выполненная работа,
  выполнение, склад, hubex, хабекс, хубекс, хабикс
...
<ol>
  ...
  <li>
    ...
    <br>
    <img src="/attachments/images/FAQ/RELEASENOTES/WarehouseChange24062025/GfqZ977y_Screenshot-2025-06-25-at-21-07-10.png" alt="Смена склада у израсходованного материала" style="margin-top: 10px;" />
  </li>
