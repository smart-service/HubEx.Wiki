...
description: 'Подборка обучающих видео по HubEx: обзор возможностей системы, первые шаги для начала работы и инструкция по импорту данных через Excel.'
category: user
---
...
Также читайте [статью](./HubExStepByStep.html), в которой подробно описаны первые шаги для работы с системой HubEx.
