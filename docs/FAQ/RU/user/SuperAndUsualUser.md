...
description: >-
  Владелец тенанта имеет две учетные записи в системе. Первая запись
  обозначается при входе как Имя_пользователя (Системный администратор). Вторая
  запись обозначается как Имя_пользователя.
keywords: >-
  владелец тенанта, тенант, учетная запись владельца тенанта, hubex, хабекс,
  хубекс, хабикс
category: user
---
