...
<p><Strong>Отчет по сотрудникам</Strong> в HubEx дает возможность проанализировать данные, собранные по
    ...
    <p>Совместно с чтением данной статьи рекомендуем к просмотру обучающий <a href="https://wiki.hubex.ru/index_video.html#EngineersAnalitics">видеоролик по работе с Отчетом по сотрудникам</a>.</p>
