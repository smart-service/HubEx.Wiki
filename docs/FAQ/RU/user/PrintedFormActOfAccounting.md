...
<p><strong>Бухгалтерский акт</strong> находится в меню <strong>Печатные формы</strong>. Использование печатных форм
    таких, как бухгалтерский акт, сервисный акт, счет на оплату является
...
<p>Рассмотрим, как сформировать акт для экспорта или печати. Перейдите в меню <strong>Печатные формы - Бухгалтерский
    ...
    <p>Обратите внимание! При подключении <strong>Бухгалтерского акта</strong> в панели <strong>Параметры</strong> будут доступно ограниченное количество фильтров, расширить функционал настроек вы можете также, обратившись в нашу службу поддержки по почте <a
            href="mailto:support@hubex.ru" target="_blank" rel="noopener">
        support@hubex.ru</a>.</p>
