...
description: >-
  ...
  включенном доступе к геопозиции в настройках приложения. Вы не сможете принять
  Заявку в работу, выехать на работы и т.д. при отключенных настройках
  геопозиции.
keywords: >-
...
<p>Также доступ к геопозиции на мобильном телефоне необходим, чтобы <strong>Сотрудник</strong> корректно отображался на
    картах в web приложении. Подробнее читайте в статьях: <a
            href="./GeoPosition.html">Карта: текущая геопозиция сотрудников</a>, <a
            href="./TicketsOnMap.html">Заявки
        и сотрудники на карте</a>, <a href="./Geotracking.html">История
        перемещений</a>.</p>
