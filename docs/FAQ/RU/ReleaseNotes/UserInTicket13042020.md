...
description: 'В HubEx при выборе исполнителя заявки можно сразу посмотреть его календарь и загруженность, а время выполнения задать вручную или перетаскиванием.'
keywords: 
