...
description: >-
  В данной статье будут рассмотрены два сценария по организации складского учета
  в HubEx. Подходящий для вас сценарий позволит вам предотвратить перерасход,
  злоупотребления, кражу и потерю товарно-материальных ценностей (далее - ТМЦ).
keywords: >-
  склад, складской учет, запасы, управление запасами, закупки, расход, hubex,
...
<p>После настройки интеграции в HubEx необходимо <a href="./Materials.html#matimp">загрузить
...
<div class="note-card">
        ...
        <div class="note-text">
            ...
            <a href="./Materials.html" target="_blank" rel="noopener noreferrer">
                Загрузка материалов и создание складов</a>.
        </div>
        <div class="meta-tag">Справочная информация</div>
    </div>   
<p>Списание материалов в HubEx происходит во время заполнения выполненных работ в Заявке. В выполненных работах
    <a href="./Withdrawals.html">указываются израсходованные ТМЦ</a>.</p>
...
<p>В течение нескольких дней вам необходимо будет провести инвентаризацию своих запасов. Затем сформированный список
    ...
    Подробнее читайте в статье: <a href="./Materials.html">Загрузка материалов и
...
<p>При поступлении новых ТМЦ или при следующей процедуре инвентаризации вы сможете свести остатки и загрузить новую
    ...
    статье: <a
            href="./Materials.html#count">Загрузка материалов и создание складов:
...
<ul>
    <li>проверять <a href="./Materials.html#wima">наличие необходимых
        материалов</a> на складе из мобильного приложения <strong>HubEx иполнитель</strong>;
    </li>
    <li>вносить <a href="./Withdrawals.html">расход использованных материалов</a>
