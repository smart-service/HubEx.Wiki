...
description: >-
  Шаблон объектов в HubEx необходим для оперативного добавления новых объектов с
  помощью мобильного приложения исполнителя. Приемка новых объектов может
  сопровождаться привязкой к QR-кодам. В дальнейшем такая связь позволит
  создавать заявки при сканировании QR-кода, привязанного к объекту.
keywords: >-
  qr-код, шаблон объектов, приемка и маркировка, шаблон оборудования, публикация
  объекта, опубликовать объект, hubex, хабекс, хубекс, хабикс
category: user
---
...
<ul>
    ...
    <li>Заполните <strong>Участок</strong>, к которому должно принадлежать оборудование (<strong>Участков</strong> может
        ...
        читайте в статье: <a href="../admin/Places.html">Настройка участков</a>;
    </li>
    <li><strong>График работы оборудования</strong> - это справочный параметр, необязательный для заполнения;</li>
    <li><strong>Класс оборудования</strong> - характеристика оборудования. Если вы не ведете учет по
        ...
        В мобильном приложении без выбора Класса объект создать нельзя. Подробнее читайте в статье: <a
                href="../admin/ObjectClass.html">Классы оборудования</a>.
    </li>
</ul>
<p>Подробнее о значение и правилах заполнения полей вы можете прочитать в статье <a
        href="./CreatingObjects.html">Создание обслуживаемого оборудования</a>.</p>
...
<p>На вкладке <strong>Дополнительные поля</strong> вы можете указать и заполнить свои персональные поля. Подробнее
    читайте в статье:
    <a href="./AdditionalFields.html">Создание дополнительных полей для
        объекта</a>.</p>
...
<ol>
    ...
    <li>вы сначала создаете QR-код в web-приложении без привязки к конкретному оборудованию, распечатываете его и
        ...
        оборудование, затем маркируете. Как создать свой QR-код читайте в статье: <a
                href="./CreatingTaskTemplates.html">Создание шаблона заявки, подача
            заявки по QR-коду</a>.
    </li>
</ol>
...
<p>С помощью цифровых шильд вы сможете предоставить своим клиентам удобный способ быстро подать <strong>Заявку</strong> на обслуживание: им нужно будет только отсканировать QR-стикер камерой смартфона. Подробнее об этом читайте в следующей статье: <a href="./CreatingTaskTemplates.html">Создание шаблона заявки, подача заявки по QR-коду</a>. </p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 70%;"
...
<p>Для того, чтобы по созданным в мобильном приложении <strong>Объектам</strong> можно было создавать
    ...
    меню <strong>Объекты|Оборудование</strong> и с помощью фильтров отберите неопубликованные объекты. Неопубликованные
    объекты
