...
description: >-
  Создание и настройка ролей в HubEx находится в меню консоли администрирования
  Администрирование - Роли. Для создания новой Роли нажмите кнопку Добавить
  роль. Для каждой роли необходимо назначить полномочия, которые определяют
  уровень доступа.
keywords: >-
  роль, доступ, настроить роль, создать роль, доступ в разрезе участков,
  полномочия, hubex, хабекс, хубекс, хабикс
category: admin
---
