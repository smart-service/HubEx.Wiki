...
<p>Пользователь создает <Strong>Заявку</Strong>, но не может найти в справочнике нужный <Strong>Объект</Strong>. Например, диспетчер или администратор
    создал новый <Strong>Объект</Strong>, и просит исполнителя (например, сервисного инженера) создать по нему <Strong>Заявку</Strong>. Но исполнителя, по каким-то причинам
