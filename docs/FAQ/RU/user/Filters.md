...
<p>Также в табличном отображении списка вы можете настраивать очередность полей. Для этого зажмите и удерживайте правую
    кнопку мышки на наименовании колонки и перенести ее в нужное место. </p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 95%;"
...
<ul>
    <li>Номер заявки: для поиска по номеру можно вводить числа и буквы, если они используется в формате номера для более точного поиска.
        <p>
        <div>
            <img style="margin: 0 auto; display: block; max-width: 95%;"
    ...
    <li>Описание заявки: чем точнее и уникальнее будет задан поисковый запрос, тем лучше система обработает поиск по
    ...
    <li>Объект: если часть слова, слово целиком, словосочетания или числа совпадут с наименованием
    ...
    <li>Адрес объекта: адрес для поиска можно вводить, как часть названия города, улицы, сочетания улицы и
        номера дома через запятую.
        <p>Обратите внимание! Чем точнее вы напишите данные адреса, тем точнее будет отработан поиск подходящих <strong>Заявок</strong>.
    ...
    <li>Вид работ: если часть слова, слово целиком, словосочетания совпадут с наименованием
