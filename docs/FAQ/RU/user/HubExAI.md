...
category: user
title: >-
  Используйте встроенного чат-бота на базе искусственного интеллекта, чтобы
  получать ответы на вопросы, искать инструкции и работать с системой HubEx
  быстрее — прямо внутри интерфейса.
description: 'HubEx AI — встроенный чат-бот на базе искусственного интеллекта: отвечает на вопросы, ищет статьи базы знаний и ускоряет работу в системе HubEx.'
---
<article>
 ...
 <div style="text-align: center;">
  ...
  <section id="notice">
    ...
    <p>Для критически важных вопросов обращайтесь в поддержку: <a href="mailto:help@hubex.ru">help@hubex.ru</a> или через встроенный чат с поддержкой.</p>
  </section>
