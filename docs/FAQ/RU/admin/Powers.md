...
<ol>
    ...
    <li>Заявки: данный блок предназначен для настройки работы с меню Заявки - Все заявки.
        ...
        <ul>
            ...
            <li>Заявки на объектах, доступных пользователю: видимость Заявок для пользователя будет зависеть от настроек
                полномочий Объекты - Справочники. В зависимости от того, к каким Объектам будет разрешен доступ, такие и будут доступны
            ...
            <li>Игнорировать эксклюзивные полномочия для доступа к полям заявки: ЭТО НЕ ТО ЖЕ САМОЕ ЧТО И ???? Предоставляет доступ на чтение и запись для всех компонентов формы заявки вне зависимости от полномочий
                и настроек
                стадии: </li>
    ...
    <li>Интеграция: данный блок предназначен для настройки доступа к работе с меню консоли администрирования
        Интеграция. ЭТОТ БЛОК ОСТАВЛЯЕМ? Я УБРАЛА СТАТЬЮ ПРО ИНТЕГРАЦИЮ С БИТРИКС ГДЕ БЫЛИ ВЕБХУКИ И ТД
        <div>
            <img style="margin: 0 auto; display: block; max-width: 80%;"
                 src="/attachments/images/FAQ/ADMIN/Powers/LifeCycle.jpg"/>
        </div>
        ...
        <ul>
            ...
            <li>Создание webhook'а: при включении полномочия в меню Интеграция - Webhook'и появляется кнопка Создать Webhook;
            </li>
            ...
            <li>Сохранение webhook'а: при включении полномочия в меню Интеграция - Webhook'и на форме созданния Webhook'a появится кнопка Сохранить;
            </li>
            ...
            <li>Пункт административной панели - Переменные: включение полномочия предоставляет доступ к меню
                консоли
                администрирования Интеграция - Ключи;</li>
            <li>Создание переменных в интеграции: при включении полномочия в меню Интеграция - Ключи появляется кнопка Создать ключ;</li>
            ...
            <li>Пункт административной панели - Служебные пользователи: ;
            </li>
            <li>Управление API-пользователем;
            </li>
