...
После нажатия на кнопку экспорта заявок, нажмите на "Расширенный экспорт", затем у Вас откроется окошко выбора экспортируемых полей. Важно отметить, что теперь также можно экспортировать "Чеклисты", "Выполненные работы" и "Сообщения".
