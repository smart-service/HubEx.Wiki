...
description: 'В заявке HubEx можно назначать исполнителя прямо с карты: видно, кто из сотрудников ближе всего к адресу заявки, и можно проверить его местоположение.'
keywords: 
