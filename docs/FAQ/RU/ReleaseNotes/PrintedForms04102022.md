...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/PrintedFormAct.md" target="_blank">Сервисный акт</a>.</p>
...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/PrintedFormActOfAccounting.md" target="_blank" rel="noopener">Бухгалтерский акт</a>.</p>
...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/PaymentInvoice.md" target="_blank" rel="noopener">Счет на оплату</a>.</p>
...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/PlannedTicketsSchedule.md" target="_blank" rel="noopener">График обслуживания объектов</a>.</p>
