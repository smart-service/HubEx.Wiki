---
title: "\U0001F4E2 Новое в HubEx: фильтр \"Тип заявки\" в расписании"
description: 'В расписании заявок HubEx появился фильтр по типу заявки — работает во всех режимах календаря и ускоряет распределение заявок между исполнителями.'
keywords: 
