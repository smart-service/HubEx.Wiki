...
<p>В поле <strong>Вид работ</strong> необходимо выбрать те виды деятельности, которые можно осуществлять над <strong>Объектом</strong>.
    ...
    <strong>Виды работ</strong> настраиваются в карточке сотрудников-исполнителей (меню Пользователи - Сотрудники). Вид работ может быть использован в настройке автораспределения сотрудников на заявки. Подробнее об этом читайте <a href="https://wiki.hubex.ru/docs/FAQ/RU/admin/RulesOfChoice.html">здесь</a>.</p>
