...
<ul>
    ...
    <li><a href="#Deleted7">Почему нельзя удалить объекты/сотрудников/заявки навсегда;</a></li>
    <li><a href="#Deleted8">Как скрыть из справочников удаленные объекты/сотрудников/заявки.</a></li>
</ul>
</html>
...
<h2 id="Deleted4">Удаление чек-листов</h2>
...
<h2 id="Deleted5">Удаление или блокировка сотрудников</h2>
...
<h2 id="Deleted6">Удаление или блокировка заказчиков</h2>
...
<h2 id="Deleted7">Почему нельзя удалить объекты/сотрудников/заявки навсегда</h2>
...
<h2 id="Deleted8">Как скрыть из справочников удаленные объекты/сотрудников/заявки</h2>
