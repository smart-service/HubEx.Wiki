...
description: >-
  ...
  Заявки на карте. Помимо всех Заявок на карте также отображаются исполнители.
  Заявки на карте отображаются цветными флажками.
keywords: >-
  заявки на карте, назначить заявку на карте, геопозиция заявки, адрес заявки,
...
<p>В каждом списке <strong>Заявки</strong> могут различаться по цвету - это зависит от параметра
    ...
    <strong>Заявок</strong>). Подробнее читайте в статьях: <a
            ...
            href="../admin/Criticality.html">Критичность заявки</a>.</p>
...
<p>Активные
    ...
    Подробнее читайте в статье: <a href="./Filters.html">Список заявок, поиск
    ...
    <li><p>Чтобы распределить неназначенную <strong>Заявку</strong>, необходимо правой кнопкой
        ...
        <p><strong>Заявка</strong> назначается на исполнителя на текущее ближайшее время.
            ...
            Плановые трудозатраты могут быть установлены в карточках <strong>Видов работ</strong> или <strong>Типов заявки</strong>. Подробнее читайте в статьях: <a
                    href="../admin/WorkType.html">Виды работ</a>, <a
                    href="../admin/TicketType.html">Типы заявок</a>.</p>
...
- [Оценка заявок и рейтинг сотрудников](./Rating.html)
