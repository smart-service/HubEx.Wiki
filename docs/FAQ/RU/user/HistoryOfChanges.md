...
description: >-
  В Заявке на вкладке История изменений отражаются все происходящие события по
  Заявке. Вы можете проследить смену стадий, назначение исполнителя и т.д.
  Каждое зменение фиксируется по времени и дате.
...
<p>Дополнительно, чтобы перейти в старую историю изменений необходимо нажать на переключатель <strong>Новое представление</strong></p>
<div>
    <img style="margin: 0 auto; display: block; max-width: 90%;"
...
- [Создание шаблона заявки, подача заявки по QR-коду](./CreatingTaskTemplates.html)
