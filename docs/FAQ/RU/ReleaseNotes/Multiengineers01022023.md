...
description: 'Теперь на одну заявку в HubEx можно назначить сразу нескольких исполнителей — в веб-версии и мобильном приложении, с уведомлением каждого из них.'
keywords: 
...
<p>Предложения по доработкам в системе и сообщениям об ошибках просим отправлять к нам в <strong>Чат с поддержкой</strong> в веб-приложении или на почту <a href="mailto:help@hubex.ru" target="_blank" rel="noopener"> help@hubex.ru </a>.</p>
