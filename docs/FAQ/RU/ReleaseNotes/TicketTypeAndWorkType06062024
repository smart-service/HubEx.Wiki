...
<body>
<p class="p1">Мы рады представить обновление, которое улучшит вашу работу в системе <strong>HubEx</strong>. Теперь в консоли администратора при создании нового или редактировании старого <strong>Типа заявки</strong> вы можете указать, что для данного типа соответствуют определенные<strong>&nbsp;Виды работы.</strong> Эта функция позволит выбирать <strong>Виды работ,</strong> заранее отфильтрованные по выбранному <strong>Типу заявки</strong> и <strong>Объекту/Оборудованию</strong> при создании или редактировании <strong>Заявки</strong>. Данный функционал обеспечит большую гибкость в организации работы с командой и заказчиком.<span class="Apple-converted-space">&nbsp;</span></p>
