...
<ul>
        ...
        <li><a href="#checklists4">Добавление чек-листа в заявку;</a></li>
...
<p><strong>Чек-лист</strong> – это список дел или задач, которые необходимо выполнить для достижения определенного результата. Использование <strong>Чек-листов</strong> позволяет:</p>
...
<p><strong>Чек-листы</strong> отображаются в заявке на вкладке <strong>"Чек-листы"</strong>.</p>
