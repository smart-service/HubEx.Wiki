...
#### Общая аналитика
В этом разделе вы научитесь работать с дашбордом Общая аналитика, который содержит в себе:
<html>
<meta charset="utf-8">
...
<ul>
    ...
    <li><a href="#piecharts">Круговые диаграммы распределния заявок.</a></li>
