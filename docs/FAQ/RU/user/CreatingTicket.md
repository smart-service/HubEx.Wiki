...
<details><summary>Видео тут</summary><iframe src="https://www.youtube.com/embed/RtMhubKi7Jc" width="100%" height="450px" frameborder="0"
        allowfullscreen="allowfullscreen"></iframe></details>

<p>Также ознакомьтесь с видеороликом <strong>Создание заявки в HubEx: расшифровка и заполнение всех полей на форме заявки</strong>. В нем мы подробно рассказываем о назначении всех полей на форме заявки и как их правильно заполнять. </p>
