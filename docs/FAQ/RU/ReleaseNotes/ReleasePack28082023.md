...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/CreatingTicket.md" target="_blank">Создание заявки</a>.</p>
...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/CreatingTaskTemplates.md#passportl" target="_blank">Создание шаблона заявки, подача заявки по QR-коду: паспорт объекта</a>.</p>
...
<p>Подробнее читайте в статье нашей базы знаний: <a href="../user/Export.md" target="_blank">Экспорт</a>.</p>
