...
<p><Strong>Отчет по сотрудникам</Strong> в HubEx дает возможность проанализировать данные, собранные по
    ...
    сможете
    ответить на
    вопросы - Как загружены ваши сотрудники? Кто из исполнителей чаще других закрывает Заявки с нарушением срока? Кто из
...
<ol>
    <li>Группа отчетов и показателей по <Strong>Заявкам</Strong> и SLA (вкладка <Strong>Заявки и SLA</Strong>), где SLA - показатель качества
        предоставляемых услуг, основывающийся на времени исполнения (закрытия) <Strong>Заявки</Strong>;
    </li>
    <li>Группу отчетов и показателей по отработанному времени (вкладка <Strong>Отработанное время</Strong>);</li>
    <li>Показатели и KPI по сотрудникам (вкладка <Strong>Показатели и KPI</Strong>).</li>
</ol>
