...
<p>Боковая панель для работы с <strong>Заявкой</strong> позволяет улучшить полльзовательский опыт и повысить производительность работы. Вам больше не нужно будет открывать Заявки в соседних вкладках, а работать с ними прямо в текущем окне.&nbsp;</p>
<p>Как это работает?</p>
<p>Перейдите в меню <strong>Заявки - Расписание заявок</strong>. Боковая панель доступна для любого представления календаря (день, неделя, месяц) по клику на номер <strong>Заявки</strong> в списке <strong>Неназначенные</strong> или <strong>Назначенные</strong>.</p>
...
<p>Боковая панель открывается справа и содержит в себе основные поля формы <strong>Заявки</strong>. Вы можете вносить необходимы изменения: заменить <strong>Вид работ</strong>, исправить Д<strong>оговор</strong>, назначить <strong>Исполнителя&nbsp;</strong>и даже прикрепить файлы.&nbsp;</p>
...
<p>Боковая панель также доступна в истории обслуживания. Откройте любой <strong>Объект</strong> в меню <strong>Объекты|Оборудование</strong> - <strong>Объекты|Оборудование&nbsp;</strong>и перейдите на вкладку <strong>История обслуживания</strong>. Перед вами откроется список всех <strong>Заявок</strong>, сохданных по выбранному <strong>Объекту</strong>. По клику на любую из них откроется боковая панель <strong>Заявки</strong>.</p>
...
<p>Здесь, как и в боковой панел в календаре, можно вносить изменения и сохранять <strong>Заявку</strong>.</p>
