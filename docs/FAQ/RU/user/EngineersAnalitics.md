...
<p>Представление панели отчетов основывается на данных в <Strong>Заявках</Strong> в разрезе <Strong>Сотрудников</Strong>.
    ...
    рассматриваться данные именно по специалистам, которые хотя бы раз были назначены на <Strong>Заявку</Strong> за выбранный период.
...
<ol>
    <li><a href ="#first">Группа отчетов и показателей по <Strong>Заявкам</Strong> и SLA </a> (вкладка <Strong>Заявки и SLA</Strong>), где SLA - показатель качества
        предоставляемых услуг, основывающийся на времени исполнения (закрытия) <Strong>Заявки</Strong>;
    </li>
...
<ul>
    <li><strong>Количество закрытых заявок и количество нарушений SLA</strong>. Данная диаграма представляет рейтинг
        исполнителей по
        закрытым <strong>Заявкам</strong>: синие столбцы - количество закрытых Заявок исполнителем за выбранный период, красные
        столбцы - % из этих <strong>Заявок</strong>, закрытых с просрочкой.
    ...
    <li>Визуализация <strong>Зависимость нарушений SLA от среднего количества открытых заявок</strong>
        представляет собой зависимость закрытия <strong>Заявок</strong> с просрочкой от загрузки специалиста. С ее помощью вы сможете
        ...
        <p>На данной визуализации представлено две оси (два показателя): <strong>Среднее кол-во открытых заявок</strong>
            - это среднее
            количество <strong>Заявок</strong> в день, которые назначены на специалиста, т.е. его загрузка; <strong>% закрытых заявок с
                просрочкой</strong> - отражает процент </strong>Заявок</strong>, которые были закрыты с просрочкой. Каждый исполнитель на
            графике отображается
            точкой. Диаметр этой точки зависит от количества закрытых <strong>Заявок</strong> за выбранный период - чем крупнее точка,
            тем больше исполнитель закрыл <strong>Заявок</strong>.
        </p>
        ...
        <ol>
            <li><strong>Первая категория (верхний правый квадрант)</strong>: сюда попадают исполнители, у которых оба показателя
                завышены. Такие исполнители перегружены работой, не успевают закрывать <strong>Заявки</strong>. <strong>Заявки</strong> с таких
                исполнителей можно переназначить на исполнителей <strong>Третьей категории</strong>;
            </li>
            <li><strong>Вторая категория (верхний левый квадрант)</strong>: сюда попадают исполнители, у которых количество <strong>Заявок</strong> меньше
            ...
            <li><strong>Третья категория (нижний левый квадрант)</strong>: сюда попадают исполнители с минимальными нарушениями SLA при
                загруженности ниже среднего. Возможно, на таких исполнителей следует переназначать <strong>Заявки</strong> с исполнителей
                <strong>Первой категории</strong>. Будьте внимательны, здесь могут оказаться специалисты, которые работают у вас
            ...
            <li><strong>Четвертая категория (нижний правый квадрант)</strong>: сюда попадают исполнители с большим количеством <strong>Заявок</strong> и
...
<p>Если вы указали период два месяца, значит данные в таблице будут браться по всем дням недели в течение этих месяцев
    (все понедельники, все вторники и тд). Равномерное распределение закрытых <strong>Заявок</strong> означает, что планирование и
    назначение <strong>Заявок</strong>
...
<p>Например, с помощью показателя <strong>Переназначенные заявки</strong> вы сможете выявить специалиста, который часто
    ...
    специалиста не по
    его профилю и т.д. Чтобы оценить, какие от каких <strong>Заявок</strong> исполнитель отказывается, щелкните на него в таблице, а
    затем нажмите значок
    стрелки справа на панели настроек. С помощью аналитических разрезов вы сможете найти эти <strong>Заявки</strong>.</p>
...
<p>В верхней части представлены основные показатели по отработанному времени за выбранный период по всем
    исполнителям:</p>
<ol>
    <li><strong>Отработано всего</strong> (в часах) - сумма рабочего времени исполнителей по графикам работ. График работ устанавливается
    ...
    <li><strong>Выполнено работ</strong> (в часах) - это сумма отработанного времени, которое указывается на вкладке <strong>Выполнение</strong> в <strong>Заявке</strong>.
...
<p>График <Strong>Динамики показателей</Strong> - универсальный график, который покажет динамику, выбранного вами показателя. Выбрать
    ...
    количества закрытых <Strong>Заявок</Strong> за выбранный период в разбивке по дням (неделям или месяцам). В</p>
...
<p>Сотрудники с <Strong>HubEx рейтингом</Strong> = 1 считаются самыми эффективными по выполнению работ за выбранный период. Чем больше
    цифра
