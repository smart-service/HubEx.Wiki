...
description: Узнайте о правах и возможностях администратора в HubEX. Полное руководство по управлению системой, настройкам доступа и решению частых вопросов.
keywords: "администрирование HubEX, права администратора, возможности администратора, управление доступом, FAQ HubEX, настройки HubEX, руководство администратора, роль, полномочия, hubex, хабекс, хубекс, хабикс"
---
<html lang="ru">
<head>
</head>
<body>
<h2>Полномочия роли</h2>
...
<ul>
    ...
    <li><Strong>Справочники</Strong>: здесь можно настроить доступ к отображению данных в справочниках. Например, разрешить просматривать список объектов, которые относятся только к участку пользователя.
    </li>
</ul>
...
<ol>
    <li id="QR"><Strong>QR</Strong>: данный блок отвечает за настройку доступа к работе с QR-кодами и шаблонами заявок
        ...
        <ul>
            ...
            <li><Strong>Пункт главного меню в мобильном приложении - Приемка и маркировка</Strong>: полномочие отвечает за доступ к меню <Strong>Приемка и маркировка</Strong> в мобильном приложении исполнителя. Если выключить полномочие роли, то пользователь не будет иметь доступа в данный пункт меню в мобильном приложении исполнителя;
            </li>
            <li><Strong>Копирование QR кодов и планировщика</Strong>: при включении данного полномочия в меню <Strong>Заявки
                - Маркировка</Strong> в
                карточках QR-кодов (шаблонов заявок) в контекстном меню (три точки) появится пункт
...
<li id="addfields"><Strong>Графики работ</Strong>: данный блок предназначен для настройки доступа к созданию графиков работ в меню консоли администратора <Strong>Структура предприятия - Графики работы</Strong>.
    ...
    <li id="tickets"><Strong>Заявки</Strong>: данный блок предназначен для настройки работы с меню <Strong>Заявки - Все
        ...
        <ul>
            ...
            <li><Strong>Пункт главного меню - Заявки</Strong>: включение полномочия открывет доступ к основному меню <Strong>Заявки - Все заявки</Strong>;
            </li>
            ...
            <li><Strong>Добавление участника в список в сообщениях</Strong>: при включении данного полномочия в <Strong>Заявке</Strong> на вкладке <Strong>Сообщение</Strong> появляется кнопка <Strong>Добавить</Strong> (доступно только для чата с командой). Обратите внимание! Доступ к сообщениям и чату с командой включается с помощью полномочий <Strong>Сообщения - Элементы интерфейса - Чат с сотрудниками</Strong>. Доступ к списку пользователей для добавления в чат будет доступен при включении полномочия <Strong>Пользователи и контакты - Справочники - Все пользователи</Strong> (или <Strong>Пользователи и контакты - Справочники - Все пользователи на участках</Strong>). Просмотр списка участников чата доступен при включении полномочия <Strong>Сообщения - Элементы интерфейса - Просмотр списка участников в сообщениях</Strong>;
            </li>
            <div>
                <img style="margin: 0 auto; display: block; max-width: 80%;"
    ...
    <li id="object"><Strong>Объекты</Strong>: блок предназначен для настройки доступа к пункту меню web-приложения
        ...
        <ul>
            ...
            <li><Strong>Объекты у компаний пользователя</Strong>: пользователю будут доступны <Strong>Объекты</Strong>, у
               ...
               <li><Strong>Компании и объекты, находящиеся на участке пользователя</Strong>: пользователю будут доступны <Strong>Объекты</Strong>, у которых <Strong>Компания-владелец</Strong> совпадает с
                <Strong>Компанией</Strong> пользователя, а также будут доступны <Strong>Объекты</Strong>, у
                которых <Strong>Участок</Strong> совпадает с
                <Strong>Участком</Strong> пользователя.
            </li>
        </ul>
    </li>
    ...
    <li id="rating"><Strong>Настройка рейтингов исполнителей</Strong>: блок предназначен для настройки доступа к пункту
        меню консоли
        администрирования<Strong> Настройки заявки -
