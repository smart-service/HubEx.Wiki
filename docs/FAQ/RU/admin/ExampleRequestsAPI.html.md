...
* [Работа с заявками](https://wiki.hubex.ru/docs/FAQ/RU/admin/ExampleRequestsAPI.html.md#section1)
* [Работа с объектами](https://wiki.hubex.ru/docs/FAQ/RU/admin/ExampleRequestsAPI.html.md#section2)
* [Работа с компаниями](https://wiki.hubex.ru/docs/FAQ/RU/admin/ExampleRequestsAPI.html.md#section3)
* [Работа с пользователями](https://wiki.hubex.ru/docs/FAQ/RU/admin/ExampleRequestsAPI.html.md#section4)
...
Полный перечень полей, а также их тип, можно посмотреть в SWAGGER. Список сервисов представлен в статье - [Начало работы с REST API HubEx](https://wiki.hubex.ru/docs/FAQ/RU/admin/StartIntegrationAPI.html.md)
...
7. И так далее, endpoint представлены в SWAGGER. Список сервисов представлен в статье - [Начало работы с REST API HubEx](https://wiki.hubex.ru/docs/FAQ/RU/admin/StartIntegrationAPI.html.md)
...
4. И так далее, endpoint представлены в SWAGGER. Список сервисов представлен в статье - [Начало работы с REST API HubEx](https://wiki.hubex.ru/docs/FAQ/RU/admin/StartIntegrationAPI.html.md)
