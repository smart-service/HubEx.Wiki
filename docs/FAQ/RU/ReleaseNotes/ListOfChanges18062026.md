---
title: >-
  Ручное создание складов в Панели диспетчера, Ручное создание материалов в
  Панели диспетчера
description: Добавили возможность создавать вручную склады и метариалы в панели диспетчера
keywords: >-
  Склады, Материалы, импорт, создание, склад, материал, hubex, хабекс, хубекс,
  хабикс
...
<body>
<h3 dir="auto">Ручное создание складов и материалов в Панели диспетчера от 18.06.2026</h3>
...
<li class="text-start ">При импорте Материалов через Excel для склада указывать <strong>адрес</strong> необходимо через ручное редактирование на вкладке <strong>Склады</strong>. Все существующие склады работают без изменений, поле адрес в них остается пустым, пока не будет заполнено вручную.</li>
</ul>
